{
  ...
  "research.data_repository.questions": "Por favor, dirija quaisquer perguntas sobre como contribuir para Participedia  para %sinfo@participedia.net%s",
  ...
  "participedia.school.once.registered": "Uma vez registrado, você receberá por e-mail um link seguro de processamento de pagamento e mais informações sobre financiamento e próximas etapas. Observe que nosso limite de inscrições é de 50 pessoas por local, inscreva-se com antecedência para garantir sua vaga.",
  ...
  "participedia.school.p3": "Junte-se a nós na próxima Escola Participaedia sobre Inovações Democráticas Transnacionais, onde aprenderá e colaborará com os criadores da primeira assembleia global de cidadãos do mundo, os coordenadores da Conferência sobre o Futuro da Europa, os principais académicos no campo da inovação democrática e transnacional governação e activistas que conduzem a campanha global para reformar a ONU! Este programa inovador é produzido em parceria com a Memorial University, a University of Western Cape, a McMaster University, o Coady Institute, a Universidade Federal de Minas Gerais, a Innovation for Policy Foundation, a Mission Publiques, a Democracy International e um consórcio de profissionais e acadêmicos líderes.",
  "participedia.school.p4": "O evento acontecerá presencialmente de 10 a 15 de junho de 2024 simultaneamente em três locais descentralizados: Memorial University (St. John's, Canadá), University of Western Cape (Cidade do Cabo, África do Sul) e Universidade Federal de Minas Gerais. (Belo Horizonte, Brasil). A experiência no Brasil acontecerá principalmente em português/espanhol, e os três locais serão conectados por uma programação virtual exclusiva com tradução ao vivo para maximizar a acessibilidade e o impacto. Utilizando esta abordagem globalmente descentralizada, esperamos criar um ecossistema transnacional de aprendizagem que reflita o assunto, conectando estudantes e profissionais de todo o mundo entre si e com especialistas líderes.",
  ...
  "participedia.school.ui.3.li.1": "Idioma: Português/Espanhol (Primário)",
  ...
  "participedia.registration.scholarships.p1":"Os participantes podem se inscrever para participar presencialmente em todas as localidades até o preenchimento das vagas (50 vagas por campus). Bolsas limitadas estão disponíveis com base nas “necessidades” para cobrir uma parte dos custos relacionados com inscrição, viagem e alojamento. Todos os alimentos e bebidas durante o programa serão fornecidos aos participantes.",
  "participedia.registration.scholarships.p2":"O prazo para solicitar financiamento de bolsa é 29 de fevereiro de 2024. Para se inscrever, indique suas necessidades de financiamento por meio do formulário de inscrição. Os convites para bolsas serão enviados até 15 de março de 2024, sendo necessária a confirmação de aceitação até 31 de março de 2024.",
  "When": "Quando",
  "Where": "Onde",
  "Who": "Quem",
