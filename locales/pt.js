{
  ...
  "participedia.registration.scholarships.p1": "Os interessados podem se inscrever para participar presencialmente, em todas as três localidades, até o preenchimento das vagas (50 vagas por campus). Será fornecida alimentação aos participantes durante todo o evento.",
  ...
  "participedia.school.federal.university": "Universidade Federal de Minas Gerais, Belo Horizonte, Brasil",
  ...
  "participedia.school.once.registered": "Uma vez registrado, você irá receber, por e-mail, um link seguro para o processamento do pagamento e mais informações sobre as próximas etapas. Observe que o nosso limite de inscrições é de 50 pessoas por local (campus sede). Por isso, inscreva-se com antecedência para garantir sua vaga.",
  ...
  "participedia.school.p4": "O evento acontecerá presencialmente de 10 a 15 de junho de 2024, simultaneamente, em três locais: a Memorial University (St. John's, Canadá), a University of Western Cape (Cidade do Cabo, África do Sul) e a Universidade Federal de Minas Gerais (Belo Horizonte, Brasil). As três universidades serão conectados por uma plataforma virtual exclusiva, com tradução ao vivo para favorecer a acessibilidade e o impacto do evento. Com este formato global e descentralizado, esperamos criar um ecossistema transnacional de aprendizagem, que favoreça a reflexão sobre o foco do encontro, conectando estudantes e profissionais de participação de todo o mundo.",
  ...
  "participedia.school.ui.3.li.1": "Idioma: Inglês (Primário)",
  "participedia.school.ui.3.li.2": "Taxa de praticante: $400 CDN",
  "participedia.school.ui.3.li.3": "Taxa de estudante: $0 CDN",
  ...
  "participedia.school.where.answer": "Memorial University (MUN), St. Johns, Newfoundland, Canadá; Universidade de Western Cape, Cidade do Cabo, África do Sul; Universidade Federal de Minas Gerais, Belo Horizonte, Brasil",
