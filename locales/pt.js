{
  ...
  "about.contribute.p1": "Ajude a expandir nosso banco de dados editando o conteúdo existente ou publicando o seu. Leia nossa entrada% sguidelines% s ou% scontact% s nosso editor-gerente para obter mais informações.",
  ...
  "faq_a10_p1": "Por padrão, a página inicial exibe um conjunto selecionado de conteúdo em destaque. Explore o mapa da página inicial para procurar casos e organizações por local.",
  ...
  "faq_a9": "Se você criar uma entrada em um idioma diferente do inglês, consulte primeiro o menu suspenso de idiomas na parte inferior do site para ver se o idioma que você planeja inserir é suportado por nosso serviço de tradução. Selecione seu idioma no menu suspenso antes de clicar em \"Envio Rápido\" para iniciar sua entrada. Se o idioma que você deseja inserir ainda não for suportado em nosso site, %sentre em contato conosco%s para solicitá-lo. Enquanto isso, você pode usar a versão em inglês do site para enviar sua entrada. Por fim, indique o idioma entre colchetes no título da entrada, por exemplo, “Orçamento Participativo [Português]”.",
  ...
  "research.data_repository.dataverse": "Repositório de dados da Participedia",
  ...
  "research.methodology.p2": "Para obter uma explicação detalhada da história, aspirações, teoria e abordagem analítica da Participedia, consulte '% s O Projeto Participedia: Uma Introdução% s', pelos fundadores do projeto, Archon Fung e Mark E. Warren. Para obter informações sobre como você pode contribuir para o projeto, consulte nossa entrada% s guidelines% s.\n",
