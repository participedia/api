{
  ...
  "content_types.review_entries.description": "Novas entradas devem ser aprovadas por um administrador. Aprovar uma entrada aprovará automaticamente todas as entradas desse usuário e suas entradas futuras não precisarão de revisão. Bloquear uma entrada bloqueará esse usuário e excluirá permanentemente todas as suas entradas do banco de dados, revise com cuidado.",
  ...
  "faq_a15": "Todas as novas entradas são salvas automaticamente assim que quaisquer dados são inseridos no formulário. Se você iniciar uma entrada, mas não quiser publicá-la imediatamente, não há necessidade de clicar em salvar. Você pode inserir o máximo de dados que desejar no formulário e feche a janela do navegador. Depois de criar um rascunho, seus rascunhos estarão acessíveis na página do seu perfil, na guia “rascunhos”, bem como na página Envio rápido. Você pode fazer login em qualquer dispositivo e acesse seus rascunhos. Usando o botão “pré-visualizar” no formulário de inscrição, você pode ver como uma inscrição ficará depois de publicada. Se você esperar para publicar sua inscrição até que esteja mais completa, a descrição e a narrativa o texto será traduzido para todos os idiomas suportados. (Só executamos a tradução uma vez, na primeira vez que uma entrada é publicada - veja: “Como funciona a tradução?”)",
  "faq_a16": "Para evitar a publicação de entradas de spam, exigimos que os usuários solicitem a publicação ou edição das entradas no Participedia, e essas solicitações são aprovadas (ou bloqueadas) pelos administradores do site. Isso pode levar alguns dias, pois isso é feito manualmente por nossa equipe. Depois de aprovado, as alterações subsequentes serão publicadas imediatamente.",
  ...
  "error_message_file_to_large" : "Desculpe, seus arquivos são muito grandes. Tente carregar um de cada vez ou carregar arquivos menores (50 MB no total).",
  "download": "Download",
  "delete": "Excluir",
