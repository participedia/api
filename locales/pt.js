{
  ...
  "research.data_downloads.p1": "Para uma breve introdução sobre como usar dados de Participedia, incluindo exemplos de análise, consulte nosso %sGuia de Dados%s.",
  "research.data_downloads.p2": "Os dados do Participedia em tempo real estão disponíveis para download como arquivos csv nos seguintes links:",
  ...
  "teaching.learning_webinar.p1": "Esta série de webinars foi projetada para conectar pesquisadores e colaboradores da Participedia com interesses comuns e para trocar conhecimentos sobre os desafios e sucessos no campo dos métodos de ensino, teorias e casos que apoiam a participação democrática. A série foi desenvolvida e lançada em 2018 pelos Co-Presidentes do Comitê de Ensino, Treinamento e Mentoria de% sParticipedia.net% s, Drs. Joanna Ashworth e Bettina von Lieres.",
  ...
  "mission.p2": "Embora comprometida com os ideais democráticos, a Participédia não promove nenhuma agenda ideológica, programática, institucional ou governamental. Acreditamos que há muitas maneiras de fazer avançar a democracia e que elas variam de acordo com o local, a história, a cultura e os desafios baseados no contexto. Reconhecemos as desigualdades existentes na coleta, teorização e mobilização do conhecimento sobre as formas não ocidentais de inovações democráticas. A Participedia está empenhada em trabalhar para resolver esse desequilíbrio. Também reconhecemos que nem todos os casos e métodos documentados pela Participedia promoverão a democracia e que os impactos variam de acordo com o contexto. “Nossa missão é mobilizar conhecimento sobre práticas e instituições promotoras da democracia que sustentem as respostas à pergunta: Que tipo de inovação democrática funciona melhor, para quais propósitos e em que condições?",
  ...
  "know_other_lang": "%sVocê conhece outro idioma?%s",
  "name:en": "English",
  "name:fr": "French",
  "name:pt": "português",
  "name:es": "espanhol",
  ...
  "case_edit_title_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "method_edit_title_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "organization_edit_title_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "disabled_language_selector_note": "Depois de inserir o texto em Português, você pode adicionar outros idiomas.",
  "case_edit_description_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "method_edit_description_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "organization_edit_description_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "case_edit_body_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "method_edit_body_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português.",
  "organization_edit_body_locale": "Qualquer idioma que não for inserido será traduzido automaticamente do Português."
