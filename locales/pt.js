{
  ...
  "completeness.general_modal_text_3": "Por favor, leia nosso %sDiretrizes%s sobre como escrever uma entrada ou entrar em contato conosco para obter mais informações.",
  "completeness.Grammar/Spelling Edits Needed": "Gramática / Spelling Edits necessários",
  "completeness.Partial": "Parcial",
  "completeness.partial_citations_alert": "%sA entrada a seguir está faltando citações.%s Por favor, ajude-nos. %sverificar seu conteúdo%s.",
  ...
  "completeness.partial_content_modal_text_1": "As inscrições parciais são cerca de metade completas, e fazem boas vagas de início para os alunos e qualquer pessoa interessada em contribuir com o Participedia. Mais entradas parciais podem ser encontradas usando o filtro de pesquisa \"completude de entrada\" na página inicial.",
  "completeness.partial_editing_alert": "%sA entrada a seguir precisa de assistência com conteúdo e edição.%s Por favor, ajude-nos. %scompletá-lo%s.",
  "completeness.partial_editing_modal_text_1": "Esse tipo de entrada precisa de melhorias significativas em sua gramática ou ortografia, e pode ser qualquer nível de completude (stub, parcial ou completo). Entradas que precisam de gramática ou edições ortográficas podem ser identificadas usando o filtro de pesquisa \"completude de entrada\" na página inicial.",
  "completeness.Stub": "Esboço",
  "completeness.stub_alert": "%sA entrada a seguir é um stub.%s Por favor, ajude-nos. %scompletá-lo%s.",
