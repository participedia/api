{
  ...
  "faq_a1": "Os casos são eventos e instâncias de política participativa e governança de todas as formas e tamanhos.",
  "faq_a10_p1": "Por padrão, a seção de resultados de pesquisa da página inicial exibe um conjunto com curadoria de conteúdo em destaque. Explore o mapa da página inicial para encontrar conteúdo por localização.",
  "faq_a10_p2": "Use a barra de pesquisa na parte superior de qualquer página para realizar uma pesquisa em todo o site usando uma ou mais palavras-chave. Depois que os resultados da pesquisa forem exibidos, classifique os resultados por tipo de conteúdo, como casos, métodos ou organizações.",
  "faq_a10_p3": "Para realizar uma pesquisa avançada, use a seguinte sintaxe:",
  "faq_a10_p4": "E: bicicleta e Rally (este é o padrão, então o mesmo que Rally de bicicleta) retornará itens que correspondem a ambas as palavras",
  "faq_a10_p5": "OU: a bicicleta ou a reunião combinarão artigos com uma ou ambas as palavras",
  "faq_a10_p6": "NOT: bicicleta não Rally vai combinar itens que contêm bicicleta, mas só se eles não contêm também Rally",
  "faq_a10_p7": "Cotações: as direitas das mulheres retornarão os artigos que têm as mulheres seguidas por direitas",
  "faq_a10_p8": "PARÊNTESES: (bicicleta ou Rally) e (direitos das mulheres e Reino Unido) irá agrupar as operações lógicas dentro dos parênteses como um grupo antes de aplicar os operadores unindo grupos",
  ...
  "faq_a12": "Acesse sua página de perfil pessoal para acessar seu conteúdo marcado.",
  "faq_a2": "Os métodos são os processos e procedimentos utilizados para orientar a política participativa e a governança.",
  "faq_a3": "As organizações são perfis de grupos formais e informais que projetam, implementam ou apoiam inovações na política participativa e na governança.",
  "faq_a4": "Os inquéritos são complementares aos dados actuais da Participedia e descrições narrativas e destinam-se a obter mais informações sobre os resultados e efeitos dos casos. As pesquisas concluídas estão vinculadas aos casos correspondentes. Consulte a página de pesquisa para obter mais informações sobre pesquisas.",
  "faq_a5": "Clique em \"entrar\" no menu principal e registre-se com um endereço de e-mail ou entre com o Google, Facebook ou LinkedIn.",
  "faq_a6": "Uma vez que você está conectado, você pode criar conteúdo clicando no botão \"enviar rápido\" no menu principal e escolhendo o tipo de artigo que você gostaria de criar.",
  "faq_a7": "Clicar em enviar rapidamente permite que você publique um caso, método ou organização em minutos, sem concluir uma entrada completa.",
  "faq_a8": "Ao visualizar um artigo de caso, método ou organização, clique no botão Editar para saltar e adicionar ou alterar a entrada atual.",
  "faq_a9": "Se você criar um artigo em um idioma diferente do inglês, por favor indique o idioma entre parênteses logo após o nome do artigo-por exemplo, \"orcamento participativo (Português)\".",
  ...
  "faq_q5": "Como faço para criar uma conta de usuário?",
