{
  ...
  "teaching.tlrc.p1": "Em breve! Como casos, métodos e organizações, qualquer pessoa poderá publicar recursos de ensino e aprendizagem para compartilhar com a Comunidade Participedia.",
  "teaching.tlrc.p2": "As inscrições no centro de recursos de ensino e aprendizagem fornecerão recursos para as configurações da sala de aula de graduação e pós-graduação, bem como recursos de desenvolvimento profissional para profissionais, organizações da sociedade civil e ONGs. Os recursos variam de currículos de curso e atribuições de classe, para manuais, simulações e material de treinamento multimídia.",
  "teaching.tlrc.resources": "Esses recursos podem ser usados para:",
  "teaching.tlrc.resources.1": "Aumentar o conhecimento dos alunos sobre inovações na democracia participativa;",
  "teaching.tlrc.resources.2": "Melhore as habilidades de pesquisa e escrita dos alunos publicando casos, métodos e organizações na Participedia;",
  "teaching.tlrc.resources.3": "Foco no conteúdo da Participedia e sua conexão com material teórico relevante;",
  "teaching.tlrc.resources.4": "Prepare os alunos para serem organizadores e pesquisadores de inovações democráticas, e;",
  "teaching.tlrc.resources.5": "Pedagogia da forma e cultura da sala de aula para ser mais participativa.",
