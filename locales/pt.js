{
  ...
  "about.committees.design_tech.p1": "A equipe de design e tecnologia pesquisa e responde às necessidades e objetivos do projeto da Participedia e sua comunidade, testando e desenvolvendo a plataforma Participedia de código aberto. A equipe de design e tecnologia é composta principalmente por estudantes de graduação e pós-graduação do estúdio de estética extensiva na Emily Carr University of Art + Design. Seus membros contribuem para a concepção e desenvolvimento do projeto Participedia a liderança de Emily Carr membro do corpo docente, Amber Frid-Jimenez, Canada Research Chair em arte e design de tecnologia e diretor do estúdio de estética extensiva.",
  ...
  "about.committees.teaching_training_mentoring.p1": "A formação docente e a Comissão de mentoring são responsáveis pela integração dos materiais da Participedia na pedagogia, no ensino, no envolvimento dos alunos e na formação de profissionais e funcionários públicos.",
  ...
  "about.community.p2": "Participedia foi fundada por Archon Fung (Kennedy School of Government, Harvard University) e Mark E. Warren (departamento de ciência política, Universidade da Colúmbia Britânica), e é guiado por um conjunto de comitês permanentes.",
  ...
  "about.get_involved.p1": "Qualquer pessoa pode participar da Comunidade Participedia e ajudar a crowdsource, catalogar e comparar processos políticos participativos em todo o mundo. Todo o conteúdo da Participedia é produzido de forma colaborativa e de código aberto uma licença Creative Commons.",
  ...
  "about.organizations.example": "Por exemplo, %sApatia é chato%s é uma ONG canadense que usa métodos de artes participativas e educação democrática para engajar os jovens na política.",
  "about.organizations.p1": "As organizações são perfis de grupos formais e informais que projetam, implementam ou apoiam inovações na política participativa e na governança.",
  "about.partners.p1": "Participedia é construída sobre uma parceria global entre organizações, instituições e indivíduos que compartilham um interesse em política participativa e governança. Os nossos parceiros incluem cocandidatos e colaboradores no âmbito do subsídio de parceria SSHRC. Entre em contato conosco se você gostaria de apoiar a missão global do projeto Participedia para ampliar o uso e conhecimento da inovação democrática, tornando-se um parceiro.",
  "about.rdc.description": "O Comitê de design de pesquisa é responsável por definir a direção estratégica da agenda de pesquisa da PPedia.",
  ...
  "about.supporters.p2": "A equipe de design & tecnologia opera fora do %sEstúdio para estética extensa%s na Emily Carr University of Art & Design, e é apoiado pelo %sPrograma de cadeiras de pesquisa do Canadá%se o %sFundação Canadá para a inovação%s.",
  "about.supporters.p3": "Software de gestão de tradução para este site é fornecido por %sPhraseApp%s.",
  "about.supporters.p4": "O projeto foi previamente financiado por um subsídio de parceria SSHRC de dois anos a partir de abril de 2011-2013. E, uma versão anterior do site Participedia incluiu um protótipo para a funcionalidade da língua alemã, desenvolvido o generoso apoio do %sFundação Bertelsmann%s em 2012.",
  ...
  "about.tools_techniques.example": "Por exemplo, %sVotação deliberativa®%s é um método que utiliza ferramentas e técnicas como %sseleção aleatória%s, %sPesquisas%sE %sfacilitou as discussões em pequenos grupos%s.",
  ...
  "about.ttmc.decription": "O Comitê de treinamento e mentoring é responsável pelo desenvolvimento de realizações e implementação de ações para a integração de materiais Participedia em pedagogia, ensino, envolvimento dos alunos e capacitação de profissionais e funcionários públicos.",
  "about.ttmc.title": "Treinamento de ensino e Comitê de mentoring",
  ...
  "case_edit_audio_title_instructional": "Forneça um título ou uma descrição deste áudio em 10 palavras ou menos.",
  "case_edit_audio_title_placeholder": "Título ou descrição",
  "case_edit_audio_url_placeholder": "Adicionar link para áudio",
  "case_edit_body_instructional": "A estrutura padrão a seguir facilita a comparação e a análise de entradas. Por favor, use os cabeçalhos abaixo e consulte as nossas <a href=\"https://docs.google.com/document/d/1lzhV6aoslzqaj9XhOtVUOHbSJYOPK0tiXg0ALzIkN-w/edit\" target=\"_blank\">diretrizes</a> como você preparar a sua entrada caso.",
  ...
  "case_edit_change_types_info": "Forneça detalhes adicionais na seção \"influência, resultados e efeitos\" da narrativa do caso. ",
  ...
  "case_edit_completeness_label": "Completude de entrada",
  ...
  "case_edit_description_instructional": "Digite tweet-Length (280 caracteres ou menos) descrição deste caso.",
  "case_edit_description_label": "Descrição breve",
  "case_edit_description_placeholder": "Digite a descrição do comprimento do tweet",
  ...
  "case_edit_evaluation_reports_placeholder": "Clique para selecionar ou arrastar e soltar arquivos aqui",
  ...
  "case_edit_facetoface_online_or_both_instructional": "Será que os participantes interagem cara a cara, on-line, ou ambos?",
  "case_edit_facetoface_online_or_both_label": "Face a face, online ou ambos",
  "case_edit_facetoface_online_or_both_placeholder": "A interação era cara a cara ou online?",
  "case_edit_facilitators_instructional": "Será que os facilitadores ajudar a orientar parte ou todo este caso?",
  ...
  "case_edit_facilitator_training_instructional": "Que nível de formação os facilitadores têm?",
  ...
  "case_edit_funder_info": "Forneça informações adicionais sobre os financiadores da iniciativa na seção \"entidades de origem e financiamento\" da narrativa do caso.",
  ...
  "case_edit_general_issues_placeholder": "Select & Rank até 3 questões",
  "case_edit_hidden_instructional": "Artigos ocultos não serão aparecer nos resultados da pesquisa",
  ...
  "case_edit_insights_outcomes_instructional": "Selecione até três maneiras pelas quais os insights e os resultados deste caso foram comunicados aos públicos-alvo pretendidos.",
  ...
  "case_edit_is_component_of_info": "Se você não conseguir encontrar o caso que você está procurando, primeiro publique esta entrada para salvar o seu trabalho. Próximo uso rápido enviar para publicar a entrada de caso ' pai '. Em seguida, retorne a essa entrada de caso e rotule esse caso como um componente do novo caso ' pai '.",
  "case_edit_is_component_of_instructional": "Um caso só pode ser um componente de um outro caso, e o outro caso já deve ser publicado no Participedia. Digite para procurar um caso existente em Participedia para rotular Este caso como um componente dele. Selecione um. ",
  "case_edit_is_component_of_label": "Tornar este caso um componente de outro caso",
  "case_edit_is_component_of_placeholder": "Pesquisar caso/pai existente",
  "case_edit_learning_resources_instructional": "Que tipos de informações de fundo foram fornecidas para os participantes?",
  "case_edit_learning_resources_label": "Informações e recursos de aprendizado",
  "case_edit_learning_resources_placeholder": "Identifique informações (se houver) fornecidas",
  "case_edit_legality_instructional": "O método global utilizado neste caso é considerado legal pelas autoridades judiciais?",
  ...
  "case_edit_location_instructional": "Digite para selecionar um endereço, cidade ou país onde ocorreram as atividades de caso primário. Listar quaisquer locais adicionais na narrativa do caso em \"entidades de origem e financiamento\". Você também pode desejar criar componentes de caso separados para os locais de outras atividades de caso.",
  "case_edit_location_label": "Localização primária",
  "case_edit_location_placeholder": "Tipo para procurar um local conhecido",
  "case_edit_method_types_info": "Há uma enorme variedade na gama de métodos participativos. Para ajudar a reduzi-lo, selecione e classifique até três dos seguintes tipos de métodos usados neste caso. Especificar quais tipos de métodos foram usados facilita para os usuários do Participedia encontrar casos semelhantes. ",
  ...
  "case_edit_method_types_placeholder": "Select & Rank até 3 tipos",
  ...
  "case_edit_ongoing_label": "Contínua",
  "case_edit_ongoing_placeholder": "Este caso está em curso?",
  "case_edit_open_limited_instructional": "Isso foi aberto a todos ou limitado a um subconjunto da população?",
  ...
  "case_edit_participants_interactions_instructional": "Selecione e classifique até três tipos de interações em ordem de relevância, com com \"1\" indicando a forma mais freqüentemente usada de interação.",
  "case_edit_participants_interactions_label": "Tipos de interação entre os participantes",
  "case_edit_participants_interactions_placeholder": "Selecionar e classificar até 3 tipos de interação",
  ...
  "case_edit_photos_title_instructional": "Forneça um título ou uma descrição desta imagem em 10 palavras ou menos.",
  ...
  "case_edit_primary_organizer_label": "Organizador/gerente primário",
  "case_edit_primary_organizer_placeholder": "Digite para pesquisar e gerar possíveis correspondências de banco de dados",
  "case_edit_public_spectrum_instructional": "Que tipo de objetivo do espectro IAP2 de participação pública este caso representa melhor?",
  "case_edit_public_spectrum_label": "Espectro de participação pública",
  "case_edit_public_spectrum_placeholder": "Selecione uma meta",
  "case_edit_purposes_instructional": "Selecione e classifique até três finalidades, com \"1\" indicando o mais relevante.",
  "case_edit_purposes_label": "Finalidade/objetivo",
  "case_edit_purposes_placeholder": "Selecione & Rank até 3 finalidades/objetivos",
  ...
  "case_edit_scope_of_influence_instructional": "Qual é o âmbito geográfico ou jurisdicional deste caso?",
  ...
  "case_edit_specific_methods_tools_techniques_instructional": "Que métodos específicos, ferramentas e técnicas foram utilizados neste caso? Digite para selecionar a partir de entradas já no banco de dados Participedia.",
  "case_edit_specific_methods_tools_techniques_label": "Métodos específicos, ferramentas e técnicas",
  "case_edit_specific_methods_tools_techniques_placeholder": "Digite para pesquisar e gerar possíveis correspondências de banco de dados",
  "case_edit_specific_topics_instructional": "Ordem de classificação até três dos tópicos mais relevantes, específicos, com \"1\" indicando o tópico mais relevante.",
  "case_edit_specific_topics_label": "Tópicos específicos",
  "case_edit_specific_topics_placeholder": "Select & Rank até 3 tópicos",
  "case_edit_staff_instructional": "Algum funcionário ou consultores envolvidos neste caso?",
  ...
  "case_edit_start_date_placeholder": "Selecione uma data de início ou data de um único evento",
  ...
  "case_edit_targeted_participants_label": "Demografia direcionada",
  "case_edit_targeted_participants_placeholder": "Identifique até 3 grupos recrutados",
  ...
  "case_edit_title_instructional": "Dar a este projeto de participação pública ou evento um título descritivo em 10 palavras ou menos. Por exemplo, \"diálogo brasileiro sobre a diversidade\" ou \"Fórum de questões públicas da cidade de Nova York\".",
  "case_edit_title_label": "Título do caso",
  "case_edit_title_placeholder": "Digite o título em 10 palavras ou menos",
  ...
  "case_edit_videos_title_instructional": "Forneça um título ou uma descrição deste vídeo em 10 palavras ou menos.",
  ...
  "case_view_change_types_label": "Tipos de alteração",
  ...
  "case_view_insights_outcomes_label": "Comunicação de insights & resultados",
  ...
  "case_view_ongoing_label": "Contínua",
  ...
  "case_view_primary_organizer_label": "Organizador/gerente primário",
  ...
  "case_view_scope_of_influence_label": "Âmbito de influência",
  ...
  "case_view_targeted_participants_label": "Demografia direcionada",
  ...
  "Co-Chairs, Teaching, Training and Mentoring Committee": "Co-presidentes, Comitê de ensino, treinamento e mentoring",
  ...
  "date_sectionlabel": "Data & duração",
  "Denmark": "Dinamarca",
  "description_instructional": "Digite tweet-Length (280 caracteres ou menos) descrição deste caso.",
  ...
  "Estonia": "Estônia",
  "Ethiopia": "Etiópia",
  "evaluation_links_link_label": "Relatório de avaliação links",
  ...
  "faq_a10_p2": "Use a barra de pesquisa na parte superior de qualquer página para realizar uma pesquisa de palavras-chave em todo o site. Depois que os resultados da pesquisa forem exibidos, você poderá classificá-los por tipo de conteúdo, como casos, métodos ou organizações.",
  ...
  "faq_a10_p8": "Parênteses: %s(bicicleta ou Rally)%s E %s(direitos das mulheres e Reino Unido)%s irá agrupar operações lógicas dentro dos parênteses como um grupo antes de aplicar os operadores unindo grupos",
  "faq_a11": "Para aceder a uma conta a partir de uma versão anterior do Participedia (antes de 2019), terá de repor a palavra-passe utilizando o mesmo endereço de e-mail que utilizou para iniciar sessão no antigo Web site. Clique em \"login\" e digite seu endereço de e-mail. Em seguida, clique em \"esqueceu sua senha?\" e siga as instruções para acessar sua conta original e seu conteúdo. Por favor %sentre em contato conosco%s Se precisar de ajuda.",
  "faq_a12": "Quando estiver conectado, clique no seu avatar de perfil no canto superior direito da tela para visitar sua página de perfil. A partir daí você pode acessar seu conteúdo marcado a aba bookmarks. Só você pode ver o seu conteúdo marcado. ",
  "faq_a2": "As inscrições sobre métodos fornecem informações sobre os processos abrangentes usados para orientar a participação do público, como júris de cidadãos, sondagem deliberativa e orçamento participativo. Por favor, leia nosso %sDiretrizes%s sobre como escrever uma entrada de método ou %sContato%s nosso editor de gerenciamento para mais informações.",
  ...
  "faq_a4": "Os inquéritos são complementares aos dados atuais da Participedia e descrições narrativas, e destinam-se a obter mais informações sobre os resultados e efeitos dos casos. As pesquisas concluídas estão vinculadas aos casos correspondentes. Consulte o %sPágina de pesquisa%s para obter mais informações sobre pesquisas.",
  "faq_a5": "Para criar uma nova conta, clique em \"login\" na barra de menu principal.",
  "faq_a6": "Uma vez que você está conectado, você pode criar conteúdo clicando no botão \"enviar rápido\" no menu principal e escolhendo o tipo de artigo que você gostaria de criar. Por favor, reveja o nosso %sDiretrizes%s sobre como escrever participações Participedia ou %sContato%s nosso editor de gerenciamento para mais informações.",
  ...
  "faq_q11": "Como posso aceder a uma conta de utilizador antiga?",
  ...
  "Latvia": "Letônia",
  "Lead Designer & Communities Coordinator": "Coordenador de Lead Designer e comunidades",
  "Lead Developer": "Desenvolvedor líder",
  "Lead Graphic Designer": "Designer gráfico de chumbo",
  "Lebanon": "Líbano",
  "Lesotho": "Lesoto",
  "level_complexity_instructional": "Selecione o nível de complexidade que esse método pode manipular.",
  "level_complexity_label": "Nível de complexidade este método pode manipular",
  "level_complexity_placeholder": "Selecione o nível de complexidade",
  "level_polarization_instructional": "Selecione o nível de polarização política que este método pode manipular.",
  "level_polarization_label": "Nível de polarização este método pode manipular",
  ...
  "method_edit_audio_title_instructional": "Forneça um título ou uma descrição deste áudio em 10 palavras ou menos.",
  ...
  "method_edit_completeness_label": "Completude de entrada",
  ...
  "method_edit_description_instructional": "Digite tweet-Length (280 caracteres ou menos) descrição deste método.",
  "method_edit_description_label": "Descrição breve",
  "method_edit_description_placeholder": "Digite a descrição do comprimento do tweet",
  "method_edit_facetoface_online_or_both_instructional": "Os participantes podem usar esse método interagem cara a cara, on-line ou ambos?",
  ...
  "method_edit_files_title_instructional": "Forneça um título ou uma descrição deste arquivo em 10 palavras ou menos.",
  "method_edit_files_title_placeholder": "Título ou descrição",
  "method_edit_hidden_instructional": "Artigos ocultos não serão aparecer nos resultados da pesquisa",
  ...
  "method_edit_level_complexity_label": "Nível de complexidade este método pode manipular",
  "method_edit_level_complexity_placeholder": "Selecione o nível de complexidade",
  "method_edit_level_polarization_info": "Selecione o nível de polarização política que este método pode manipular\nBolha da informação: a baixa polarização existe quando uma iniciativa da participação pública pode supor o acordo básico em objetivos, tais como o desejo do pessoa para serviços de fogo da emergência. A polarização elevada existe quando as atitudes públicas são divididas fortemente entre duas ou mais opções. Isto é frequentemente lig ao Partisanship, aos animosities de longa data, e à confiança baixa.",
  "method_edit_level_polarization_instructional": "Selecione o nível de polarização política que este método pode manipular.",
  "method_edit_level_polarization_label": "Nível de polarização este método pode manipular",
  ...
  "method_edit_links_title_instructional": "Forneça um título ou uma descrição deste conteúdo vinculado em 10 palavras ou menos.",
  ...
  "method_edit_method_types_placeholder": "Select & Rank até 3 tipos",
  "method_edit_number_of_participants_instructional": "Selecione e classifique até três tamanhos de grupo que esse método pode acomodar, com \"1\" indicando o tamanho ideal.",
  ...
  "method_edit_photos_placeholder": "Clique para selecionar ou arrastar e soltar imagens aqui",
  "method_edit_photos_source_url_instructional": "Se aplicável, forneça um link para onde a imagem original foi originária.",
  "method_edit_photos_source_url_placeholder": "Link para o original",
  "method_edit_photos_title_instructional": "Forneça um título ou uma descrição desta imagem em 10 palavras ou menos.",
  ...
  "method_edit_purpose_method_placeholder": "Select & Rank até 3 propósitos",
  ...
  "method_edit_scope_of_influence_label": "Âmbito de aplicação",
  "method_edit_scope_of_influence_placeholder": "Selecionar Escopo geográfico ou jurisdicional",
  "method_edit_title_instructional": "Dê a este método um nome descritivo em 10 palavras ou menos.",
  "method_edit_title_label": "Título do método",
  "method_edit_title_placeholder": "Digite o título em 10 palavras ou menos",
  ...
  "method_view_level_polarization_label": "Nível de polarização este método pode manipular",
  ...
  "method_view_scope_of_influence_label": "Âmbito de aplicação",
  ...
  "Most Recent Changes By": "Alterações mais recentes por",
  "most_recent_label": "Alterações mais recentes por",
  "Mozambique": "Moçambique",
  "Myanmar": "Myanmar",
  "name:approaches-key:advocacy": "Advocacia",
  ...
  "name:approaches-key:informal_engagement-longValue": "Engajamento informal de intermediários com autoridades políticas (por exemplo, negociação e negociações em nome de setores marginalizados)",
  ...
  "name:approaches-key:protest": "Protesto",
  ...
  "name:approaches-key:research-longValue": "Pesquisa (por exemplo, pesquisas de opinião pública; grupos focais; pesquisa de ação participativa)",
  ...
  "name:completeness-key:partial_editing": "Gramática / Spelling Edits necessários",
  "name:completeness-key:stub": "Stub (menos da metade completa)",
  ...
  "name:decision_methods-key:idea-longValue": "Geração de ideias (i.e. soluções potenciais foram geradas, mas não foram decididas prioridades)",
  "name:decision_methods-key:n/a": "Não aplicável",
  "name:decision_methods-key:n/a-longValue": "Não aplicável (por exemplo, os votos não são tipicamente tomados em manifestações de protesto)",
  ...
  "name:facilitator_training-key:trained": "Facilitadores treinados e não profissionais",
  "name:facilitator_training-key:untrained": "Facilitadores não treinados e não profissionais",
  ...
  "name:funder_types-key:faithbased": "Organização baseada na fé",
  ...
  "name:funder_types-key:local-longValue": "Governo local (por exemplo, vila, cidade, cidade)",
  ...
  "name:general_issues-key:labor": "Labor & trabalho",
  ...
  "name:if_voting-key:majoritarian-longValue": "Votação majoritária (i.e. 50% + 1)",
  ...
  "name:implementers_of_change-key:experts-longValue": "Peritos (por exemplo, cientistas, engenheiros, criminologistas, médicos, advogados)",
  ...
  "name:implementers_of_change-key:stakeholder-longValue": "Organizações de stakeholders (por exemplo, grupos comunitários, ONGs, interesses comerciais)",
  ...
  "name:insights_outcomes-key:traditional-longValue": "Meios tradicionais (isto é televisão, rádio, jornais)",
  ...
  "name:method_types-key:evaluation-longValue": "Avaliação, supervisão e auditoria social (ou seja, monitorização de organismos públicos e serviços para que os funcionários e as autoridades tenham em conta)",
  ...
  "name:method_types-key:internal": "Gestão interna ou organização",
  ...
  "name:method_types-key:longterm-longValue": "Organismos cívicos a longo prazo (ou seja, esforços sustentados para proporcionar ao público oportunidades de entrada e tomada de decisões, tipicamente a nível local)",
  ...
  "name:method_types-key:public_meetings-longValue": "Reuniões públicas (ou seja, reuniões patrocinadas pelo governo abertas ao público em geral, onde os funcionários públicos também podem estar presentes)",
  ...
  "name:organizer_types-key:academic": "Instituição académica",
  "name:organizer_types-key:activist": "Rede ativista",
  ...
  "name:organizer_types-key:individual": "Individuais",
  ...
  "name:organizer_types-key:philanthropic-longValue": "Organização filantrópica (ou seja, dedicada a fazer doações monetárias ou presentes)",
  ...
  "name:participants_interactions-key:ask": "Pergunte e responda perguntas",
  ...
  "name:participants_interactions-key:negotiation": "Negociação e negociações",
  ...
  "name:public_spectrum-key:empower-longValue": "Capacitar (colocar a tomada de decisão final nas mãos do público)",
  ...
  "name:purposes-key:make_influence-longValue": "Fazer, influenciar ou desafiar decisões de organizações privadas (por exemplo, organizações da sociedade civil; corporações)",
  "name:purpose_method-key:academic": "Pesquisa",
  "name:purpose_method-key:deliver": "Entregar bens e serviços",
  ...
  "name:recruitment_method-key:captive": "Amostra cativa",
  ...
  "name:scope_of_influence-key:city/town": "Cidade/cidade",
  ...
  "name:sector-key:for_profit": "Para o lucro",
  ...
  "name:specific_topics-key:access": "Acesso às frequências de rádio e televisão",
  ...
  "name:specific_topics-key:alternative": "Alternative & energias renováveis",
  ...
  "name:specific_topics-key:budget_provincial": "Orçamento-provincial, regional, estadual",
  ...
  "name:specific_topics-key:disability": "Direitos de invalidez",
  "name:specific_topics-key:disabled": "Assistência com deficiência",
  "name:specific_topics-key:disaster": "Preparação de desastres",
  "name:specific_topics-key:disease": "Prevenção de doenças",
  "name:specific_topics-key:drug": "Cobertura de drogas e custo",
  ...
  "name:specific_topics-key:elderly_housing": "Habitação de idosos",
  ...
  "name:specific_topics-key:energy_siting": "Energia siting & transmissão",
  ...
  "name:specific_topics-key:food": "Alimentos e nutrição",
  "name:specific_topics-key:food_assistance": "Assistência alimentar",
  "name:specific_topics-key:food_inspection": "Inspeção de alimentos e segurança",
  ...
  "name:specific_topics-key:homelessness": "Sem-abrigo",
  ...
  "name:specific_topics-key:intelligence": "Espionagem",
  ...
  "name:specific_topics-key:longterm": "Cuidados de longo prazo",
  ...
  "name:specific_topics-key:walkingpedestrian": "Caminhada/mobilidade pedestre",
  ...
  "name:specific_topics-key:wilderness": "Proteção da região selvagem",
  ...
  "name:tags-key:formal": "Participação formal/estruturada",
  ...
  "name:tags-key:internal": "Interno-e auto-gestão",
  "name:tags-key:mapping": "Mapeamento e análise",
  "name:tags-key:online": "Online",
  "name:tags-key:oversight": "Supervisão e monitorização",
  ...
  "name:tags-key:research": "Pesquisa/estudo",
  ...
  "name:tags-key:stateholder": "Engajamento de stakeholders",
  "name:tags-key:storytelling": "Narrativa",
  "name:tags-key:sustainability": "Sustentabilidade e vida verde",
  ...
  "name:targeted_participants-key:lgbt": "Lésbica/homossexual/bissexual/transgender",
  "name:targeted_participants-key:lgbt-longValue": "Lésbicas/gays/bissexuais/transgêneros (i.e. LGBT)",
  "name:targeted_participants-key:lowincome": "Assalariados de baixa renda",
  ...
  "name:targeted_participants-key:stakeholder-longValue": "Organizações de stakeholders (por exemplo, ONGs, interesses comerciais)",
  ...
  "name:time_limited-key:repeated": "Repetido ao longo do tempo",
  ...
  "name:tools_techniques_types-key:legislation": "Legislação, política ou estruturas",
  ...
  "name:tools_techniques_types-key:manage": "Gerencie e/ou distribua dinheiro ou recursos",
  ...
  "name:type_method-key:community-longValue": "Desenvolvimento, organização e mobilização da Comunidade (ou seja, capacitar comunidades para impulsionar, implementar e efetuar mudanças)",
  "name:type_method-key:deliberative": "Processo deliberativo e dialic",
  "name:type_method-key:deliberative-longValue": "Processo deliberativo e dialógica (ou seja, processos estruturados que envolvem deliberação e/ou diálogo como aspecto central)",
  ...
  "name:type_method-key:informal_participation-longValue": "Participação informal (ou seja, tentativas extra institucionais para garantir o acesso a recursos, direitos e representação política sem usar canais governamentais formais)",
  "name:type_method-key:internal": "Gestão interna ou organização",
  ...
  "name:type_method-key:longterm": "Órgãos cívicos de longo prazo",
  ...
  "name:type_method-key:participatory-longValue": "Artes participativas (ou seja, processos que envolvem o público como participantes na produção artística ou esforço)",
  ...
  "name:type_method-key:public-longValue": "Orçamento público (ou seja, destinado a ajudar a decidir como devem ser gastos os fundos públicos)",
  "name:type_method-key:public_meetings": "Reuniões públicas",
  "name:type_method-key:public_meetings-longValue": "Reuniões públicas (ou seja, reuniões patrocinadas pelo governo abertas ao público em geral, onde os funcionários públicos também podem estar presentes)",
  ...
  "name:type_tool-key:facilitate_decisionmaking-longValue": "Facilitar a tomada de decisões (por exemplo, classificação; multi-votação)",
  "name:type_tool-key:inform": "Informar, educar e/ou sensibilizar",
  "name:type_tool-key:inform-longValue": "Informar, educar e/ou sensibilizar (por exemplo, guia de discussão; Q&A com peritos)",
  ...
  "name:type_tool-key:manage-longValue": "Gerenciar e/ou alocar dinheiro ou recursos (por exemplo, aplicativos de orçamento móvel)",
  ...
  "name:type_tool-key:propose-longValue": "Propor e/ou desenvolver políticas, ideias e recomendações (por exemplo, brainstorming; técnica de grupo nominal)",
  ...
  "organization_edit_audio_title_instructional": "Forneça um título ou uma descrição deste áudio em 10 palavras ou menos.",
  ...
  "organization_edit_completeness_label": "Completude de entrada",
  "organization_edit_completeness_placeholder": "Selecione o nível de completude para esta entrada",
  "organization_edit_description_instructional": "Digite tweet-Length (280 caracteres ou menos) descrição desta organização",
  "organization_edit_description_label": "Descrição breve",
  "organization_edit_description_placeholder": "Digite a descrição do comprimento do tweet",
  ...
  "organization_edit_general_issues_instructional": "Ordem de classificação até três das questões mais relevantes que são de interesse principal para esta organização, com \"1\" indicando o problema mais relevante. Você será solicitado a fornecer informações mais detalhadas no campo tópicos específicos abaixo.",
  ...
  "organization_edit_hidden_instructional": "Artigos ocultos não serão aparecer nos resultados da pesquisa",
  ...
  "organization_edit_links_title_instructional": "Forneça um título ou uma descrição deste conteúdo vinculado em 10 palavras ou menos.",
  ...
  "organization_edit_location_placeholder": "Tipo para procurar um local conhecido",
  "organization_edit_methods_tools_techniques_info": "Se você não conseguir encontrar seu método, ferramenta ou técnica, primeiro publique essa entrada para salvar seu trabalho. Em seguida, adicione um novo método, ferramenta ou técnica de entrada. Em seguida, retorne a essa entrada de organização e adicione seu novo método, ferramenta ou técnica.",
  ...
  "organization_edit_photos_title_instructional": "Forneça um título ou uma descrição desta imagem em 10 palavras ou menos.",
  ...
  "organization_edit_specific_methods_tools_techniques_instructional": "Que métodos específicos, ferramentas e técnicas são usadas por esta organização? Digite para selecionar a partir de entradas já no banco de dados Participedia.",
  ...
  "organization_edit_type_method_info": "Há uma enorme variedade na gama de métodos participativos. Para ajudar a reduzi-lo, selecione e classifique até três dos seguintes tipos de métodos usados por esta organização. Especificar quais tipos de métodos são usados facilita para os usuários do Participedia encontrar organizações semelhantes. ",
  ...
  "organization_edit_type_method_placeholder": "Select & Rank até 3 tipos",
  "organization_edit_type_tool_info": "Há uma enorme variedade na gama de ferramentas participativas/técnicas. Para ajudar a reduzi-lo, selecione e classifique até três dos seguintes tipos de ferramentas/técnicas usadas por esta organização. Especificar quais tipos de ferramentas/técnicas são usados facilita para os usuários do Participedia encontrar organizações semelhantes. ",
  ...
  "organization_edit_videos_title_instructional": "Forneça um título ou uma descrição deste vídeo em 10 palavras ou menos.",
  ...
  "Participedia Design Lead and Chair, Design & Technology Committee": "Participedia líder de design e Presidente, design & Comitê de tecnologia",
  "Participedia Help": "Participedia Help",
  "Participedia on LinkedIn": "Participédia no LinkedIn",
  ...
  "research.data_repository.feature.5": "atribuição automática de identificadores de objetos digitais (DOIs) e outros metadados compatíveis com padrões para permitir a citação de conjuntos de dados;",
  "research.data_repository.feature.6": "indexação de conjuntos de dados nos principais motores de busca para ajudar os usuários a encontrarem os mesmos;",
  "research.data_repository.feature.7": "criação de impressões digitais para permitir a autenticação de conjuntos de dados; E",
  "research.data_repository.feature.8": "uma API aberta que permite que dados e metadados sejam usados por outros serviços da Web.",
  ...
  "research.data_repository.p2": "Pesquisadores e praticantes podem contribuir para o Participedia Dataverse, depositando seus materiais de pesquisa gratuitamente. As características do repositório de dados Participedia incluem:",
  ...
  "research.surveys.p1": "Os inquéritos são complementares aos dados actuais da Participedia e descrições narrativas e destinam-se a obter mais informações sobre os resultados e efeitos dos casos.",
  "research.surveys.p2": "A pesquisa participante irá captar a experiência dos participantes diretamente envolvidos em um processo participativo. Ele poderia ser entregue pelos organizadores no local de um determinado processo, ou os participantes poderiam ser solicitados a concluir a pesquisa após o evento.",
  ...
  "research.tagline": "Participedia é guiada pela questão da pesquisa: que tipos de processos participativos funcionam melhor, para que finalidades, e que condições?",
  ...
  "scope_of_influence_label": "Âmbito de influência",
  ...
  "South Georgia and the South Sandwich Islands": "Geórgia do Sul e as Ilhas Sandwich do Sul",
  ...
  "Teaching Training & Mentoring Committee": "Treinamento de ensino e Comitê de mentoring",
  ...
  "teaching.Discussion.p1": "Criamos um bate-papo em grupo onde qualquer um pode discutir recursos de ensino e aprendizagem e pedagogia democrática. Participe do Participedia Facebook Group para contribuir com a conversa e fazer perguntas da comunidade acadêmica.",
  ...
  "teaching.Participedia provides open access to": "Participedia fornece acesso aberto a recursos de crowdsourcing que são úteis para as configurações de graduação e pós-graduação, bem como recursos de desenvolvimento profissional para profissionais, organizações da sociedade civil e ONGs. Os recursos variam de currículos de curso e atribuições de classe, para manuais, simulações e material de treinamento multimídia.",
  "teaching.Please use this form": "Por favor, use %sEste formulário%s ou enviar um e-mail para %sinfo@participedia.net%s Se você tiver recursos para compartilhar.",
  ...
  "Zambia": "Zâmbia",
  "Zimbabwe": "Zimbábue",
  "Zoom Map In": "Zoom mapa em",
  "Zoom Map Out": "Zoom mapa para fora",
  "coady_students": "Graduados do Instituto Coady",
