{
  ...
  "about.cases.example": "Por exemplo, este caso sobre o %sOrçamento Participativo de Paris de 2017%s é um dos mais de 160 registros de casos que documentam o uso de métodos participativos para dar aos cidadãos maior influência sobre a distribuição de recursos públicos.",
  "about.cases.p1": "As submissões sobre %scasos%s documentam exemplos específicos de como vários métodos de política participativa e governança são implementados. Os casos podem ser contemporâneos ou históricos, concluídos ou em andamento.",
  "about.ckmc.description": "O Comitê de Comunicação e Mobilização de Conhecimento (CMC) é responsável por aconselhar o Comitê Executivo sobre como a comunicação com os parceiros de pesquisa pode ser planejada, realizada e aperfeiçoada. O comitê do CMC também aconselha sobre a comunicação ideal com a comunidade de usuários do Participedia, incluindo o apoio ao desenvolvimento de conteúdo para o site, boletim informativo e canais de mídia social.",
  ...
  "about.committees.design_tech.p1": "A Equipe de Design e Tecnologia (D&T) usa métodos de design participativo para pesquisar e responder às necessidades e aos objetivos da comunidade Participedia e é responsável por desenvolver e testar a plataforma de código aberto Participedia.net. A base de código-fonte aberto da plataforma está disponível no %sGithub%s. A equipe de D&T está comprometida com a equidade, a diversidade, a inclusão e a orientação de alunos e opera no %sStudio for Extensive Aesthetics%s da %sEmily Carr University of Art + Design%s. Seus membros, incluindo estudantes e designers profissionais e tecnólogos, contribuem para o projeto e o desenvolvimento do Participedia sob a liderança de Amber Frid-Jimenez, membro do corpo docente da Emily Carr, que é presidente de pesquisa do Canadá em tecnologia de arte e design e diretora do Studio for Extensive Aesthetics.\n",
  "about.committees.executive_committee.p1": "O comitê executivo da Participedia é composto pelos presidentes de cada comitê permanente e suas reuniões são abertas a qualquer membro de nossa equipe estendida ou co-signatários do projeto SSHRC Partnership Grant (co-investigadores, colaboradores e representantes administrativos de instituições parceiras).",
  "about.committees.p1": "Os comitês do Participedia são compostos por co-investigadores e colaboradores do projeto e são liderados por um presidente nomeado que faz parte do comitê executivo.",
  "about.committees.reasearch_design.p1": "O comitê de projeto de pesquisa define a direção estratégica da agenda de pesquisa da Participedia.",
  "about.committees.teaching_training_mentoring.p1": "O comitê de ensino, treinamento e orientação é responsável pela integração dos materiais da Participedia à pedagogia, ao ensino, ao envolvimento dos alunos e aos recursos de treinamento para profissionais e funcionários públicos.",
  "about.community.p1": "O banco de dados pesquisável da Participedia é para qualquer pessoa. A plataforma foi projetada de forma colaborativa através de uma parceria internacional de pesquisa para conectar e fortalecer seu trabalho em democracia participativa com conhecimento público de origem coletiva (crowdsourcing).",
  "about.community.p2": "Participedia foi fundada por Archon Fung (Kennedy School of Government, Harvard University) e Mark E. Warren (Departamento de Ciências Políticas da University of British Columbia), e é guiada por um conjunto de comitês permanentes.",
  ...
  "about.design_and_tech.description": "O Comitê de Design e Tecnologia é responsável pelo design e manutenção do site da Participedia.",
  "about.explore.p1": "Explore nosso banco de dados de casos, métodos e organizações usando a barra de pesquisa acima, %sfaça o download dos dados em arquivos csv%s ou %sexplore as submissões por local%s.",
  "about.explore.p2": "%s Leia mais sobre nossa pesquisa -> %s",
  "about.funders.p1": "Atualmente, o Participedia é apoiado pelo %sConselho de Pesquisa em Ciências Sociais e Humanas do Canadá%s (SSHRC) por meio de um Subsídio de Parceria de cinco anos, com início em abril de 2015. A Equipe de Design e Tecnologia opera no %sStudio for Extensive Aesthetics%s da %sEmily Carr University of Art & Design%s e é apoiada pelo %sCanada Research Chairs Program e pela Canada Foundation for Innovation%s.",
  "about.get_involved.p1": "Qualquer pessoa pode se juntar à comunidade Participedia e ajudar a coletar, catalogar e comparar processos políticos participativos em todo o mundo. A plataforma Participedia é publicada sob uma %slicença Creative Commons%s e pode ser acessada e editada por qualquer pessoa. Para obter informações sobre como contribuir com o projeto, consulte nossas %sdiretrizes%s de publicação.",
  "about.members.p1": "A Participedia é aberto a qualquer pessoa. Nossos membros incluem pessoas de todas as origens, nacionalidades e profissões. De analistas de políticas a professores, de ativistas a professores, a Participedia é um lugar para qualquer pessoa interessada em participação democrática. Nossa comunidade está no coração do nosso trabalho: ao se associar, você também pode ajudar a construir esse recurso crescente, editando submissões existentes ou publicando novos conteúdos sobre participação pública.",
  "about.methods.example": "Por exemplo, o método  %s21st Century Town Meeting%s permite que um grande número de pessoas delibere simultaneamente em pequenos grupos usando a tecnologia de resposta do público.\n\n",
  ...
  "about.methods.p1": "As submissões sobre %smétodos%s fornecem informações sobre os processos abrangentes usados ​​para orientar a participação pública, como júris de cidadãos, pesquisas deliberativas (deliberative polling) e orçamento participativo. ",
  ...
  "about.organizations.example": "Por exemplo, a %sApathy is Boring%s é uma ONG canadense que usa métodos de artes participativas e educação democrática para envolver os jovens na política.",
  "about.organizations.p1": "As submissões sobre %sorganizações%s fornecem perfis de grupos formais e informais que projetam, implementam ou apoiam inovações em política e governança participativas.",
  "about.participediaschool.a": "Confira a Escola Participadia ->",
  "about.partners.p1": "A Participedia foi criada com base em uma parceria global entre organizações, instituições e indivíduos que compartilham o interesse em políticas participativas e governança. Nossos parceiros incluem colaboradores e parceiros que se candidataram a uma bolsa do SSHRC (Conselho de Pesquisa em Ciências Sociais e Humanas do Canadá). Entre em contato conosco se quiser apoiar a missão global do Projeto Participedia de expandir o uso e o conhecimento de inovações democráticas, tornando-se um parceiro.",
  ...
  "about.rdc.description": "O Research Design Committee (Comitê de design de pesquisa) é responsável por definir a direção estratégica da agenda de pesquisa da PPedia. ",
  "about.rdc.title": "Comitê de design de pesquisa",
  "about.staff.p1": "A equipe principal de membros da Participedia mantém as atividades diárias, apoia a comunidade e garante que as metas do projeto sejam continuamente atingidas e aperfeiçoadas.",
  ...
  "about.teaching_resources.example": "Por exemplo, este  %sexemplo de tarefa e critério de avaliação%s ilustra como o Participedia pode ser usado em sala de aula.",
  "about.teaching_resources.p1": "As entradas no %sCentro de Recursos de Ensino e Aprendizagem%s oferecem recursos para salas de aula de graduação e pós-graduação, bem como recursos de desenvolvimento profissional para atuantes do campo participativo, organizações da sociedade civil e ONGs. Os recursos variam de programas de cursos e tarefas de classe a manuais, simulações e material de treinamento multimídia.",
  "about.tools_techniques.example": "Por exemplo, o %sDeliberative Polling®%s é um método que usa ferramentas e técnicas como %sseleção aleatória%s, %ssurveys%s e %sdiscussões facilitadas em pequenos grupos%s.",
  "about.tools_techniques.p1": "As submissões sobre ferramentas e técnicas fornecem informações sobre  os mecanismos e os dispositivos usados para implementar, orientar ou aprimorar os métodos participativos.",
  "about.ttmc.decription": "O Comitê de Treinamento e Orientação de Ensino (Teaching Training and Mentoring Committee) é responsável por desenvolver resultados e implementar ações para a integração dos materiais da Participedia na pedagogia, no ensino, no envolvimento dos alunos e no treinamento de profissionais e funcionários públicos.",
  "about.ttmc.title": "Comitê de Treinamento e Orientação de Ensino",
  ...
  "case_edit_representation_change_who_instructional": "Se o processo se repetiu ao longo do tempo, houve mudanças em quem atuava em nome do grupo representado?",
  "case_edit_representation_change_who_label": "Se repetido: Mudança na representação - Quem?",
  "case_edit_representation_change_who_placeholder": "Escolha uma opção",
  "case_edit_representation_change_what_instructional": "Se o processo se repetiu ao longo do tempo, houve mudanças em quem ou no que estava sendo representado?",
  "case_edit_representation_change_what_label": "Se repetido: Mudança na representação - O quê?",
  "case_edit_representation_change_what_placeholder": "Escolha uma opção",
  "case_edit_represented_shaped_instructional": "O grupo representado conseguiu definir a agenda?",
  "case_edit_represented_shaped_label": "O grupo representado definiu a agenda?",
  "case_edit_represented_shaped_placeholder": "Escolha uma opção",
  "case_edit_anonymous_identified_instructional": "Os participantes online eram anônimos ou identificados?",
  "case_edit_anonymous_identified_label": "Anônimo ou identificado online",
  "case_edit_anonymous_identified_placeholder": "Escolha uma opção",
  "case_edit_anonymous_identified_info": "Os participantes online eram anônimos ou identificados?",
  "case_edit_represented_characteristics_instructional": "Quais características identificam o grupo representado? Pense no processo e nas questões em debate. Qual é a principal característica que define o grupo representado?",
  "case_edit_represented_characteristics_label": "Características do grupo representado",
  "case_edit_represented_characteristics_placeholder": "Selecione e classifique até 3 características",
  "case_edit_represented_group_instructional": "Quem ou o que está sendo representado pelo processo?",
  "case_edit_represented_group_label": "Grupo representado",
  "case_edit_represented_group_placeholder": "Escolha uma ou várias opções",
  "case_edit_argument_tools_instructional": "Foram usados instrumentos digitais para estruturar ou mapear o argumento, como mapas de argumentos, mapas de temas, sistemas de apoio a argumentos ou sistemas de apoio à decisão? Informe quaisquer ferramentas específicas na seção narrativa deste caso.",
  "case_edit_argument_tools_label": "Ferramentas de argumentação",
  "case_edit_argument_tools_placeholder": "Selecione até três",
  "case_edit_gamification_instructional": "Foram utilizadas técnicas de gamificação? Informe quaisquer técnicas específicas de gamificação na seção narrativa deste caso.",
  "case_edit_gamification_label": "Gamificação",
  "case_edit_gamification_placeholder": "Selecione até três",
  "case_edit_facilitator_automation_instructional": "A facilitação foi automatizada parcial ou totalmente?",
  "case_edit_facilitator_automation_label": "Automação da facilitação",
  "case_edit_facilitator_automation_placeholder": "Selecione uma opção",
  "case_edit_facetoface_and_online_integration_instructional": "Quando houve interação presencial e online, os participantes presenciais e online interagiram juntos de forma síncrona na mesma sessão?",
  "case_edit_facetoface_and_online_integration_label": "Integração presencial e online",
  "case_edit_facetoface_and_online_integration_placeholder": "Selecione uma opção",
  "case_edit_synchronous_asynchronous_instructional": "A interação online foi síncrona, assíncrona ou ambas?",
  "case_edit_synchronous_asynchronous_label": "Síncrono ou assíncrono",
  "case_edit_synchronous_asynchronous_placeholder": "Selecione uma opção",
  "case_edit_text_video_instructional": "A interação online ocorreu apenas por texto ou também por comunicação audiovisual? Descreva os meios utilizados na seção narrativa deste caso.",
  "case_edit_text_video_label": "Texto e vídeo",
  "case_edit_text_video_placeholder": "Selecione uma opção",
  "case_edit_visualization_instructional": "O sistema online ofereceu uma visualização das características da discussão, como o grau de concordância entre os participantes ou o nível de apoio às ações propostas?",
  "case_edit_visualization_label": "Visualização",
  "case_edit_visualization_placeholder": "Selecione uma opção",
  "case_edit_virtual_reality_instructional": "O sistema online permitiu que os participantes experimentassem realidade virtual?",
  "case_edit_virtual_reality_label": "Realidade virtual",
  "case_edit_virtual_reality_placeholder": "Selecione uma opção",
  "case_edit_representation_claims_instructional": "Como foi comunicada a reivindicação feita para estabelecer uma ligação entre o processo e um grupo ou comunidade específicos? Selecione até três formas pelas quais a reivindicação feita para estabelecer essa ligação foi comunicada.",
  "case_edit_representation_claims_label": "Reivindicações de representação",
  "case_edit_representation_claims_placeholder": "Selecione e classifique até três",
  "case_edit_feedback_methods_instructional": "Quais métodos, se houver, o grupo ou comunidade representada utilizou para fornecer feedback sobre o processo?",
  "case_edit_feedback_methods_label": "Métodos de feedback",
  "case_edit_feedback_methods_placeholder": "Selecione até três",
  "case_edit_behind_claim_instructional": "Considere a alegação de que o processo representa um grupo ou comunidade específicos. Qual entidade estava por trás dessa reivindicação?",
  "case_edit_behind_claim_label": "Responsável pela reivindicação",
  "case_edit_behind_claim_placeholder": "Selecione uma opção",
  "case_edit_most_affected_instructional": "Pense nas pessoas ou nos elementos mais afetados pelas questões discutidas no processo. Quão bem eles foram representados?",
  "case_edit_most_affected_label": "Mais afetados",
  "case_edit_most_affected_placeholder": "Selecione uma opção",
  "case_edit_implementers_connected_instructional": "Os implementadores da mudança estão conectados ao grupo representado?",
  "case_edit_implementers_connected_label": "Implementadores conectados",
  "case_edit_implementers_connected_placeholder": "Selecione uma opção",
  "case_edit_represented_evaluation_instructional": "Se aplicável, membros do grupo representado participaram do processo de avaliação?",
  "case_edit_represented_evaluation_label": "Grupo representado na avaliação",
  "case_edit_represented_evaluation_placeholder": "Selecione uma opção",
  "case_edit_argument_tools_instructional": "Foram usados instrumentos digitais para estruturar ou mapear o argumento, como mapas de argumentos, mapas de temas, sistemas de apoio a argumentos ou sistemas de apoio à decisão? Informe quaisquer ferramentas específicas na seção narrativa deste caso.",
  "case_edit_argument_tools_label": "Ferramentas de argumentação",
  "case_edit_argument_tools_placeholder": "Selecione até três",
  "case_edit_ai_ml_instructional": "Inteligência artificial ou aprendizado de máquina foi utilizada no sistema online?",
  "case_edit_ai_ml_label": "Inteligência artificial Aprendizado de máquina",
  "case_edit_ai_ml_placeholder": "Selecione uma opção",
  ...
  "case_view_most_affected_label": "Mais afetados",
  ...
  "case_view_represented_evaluation_label": "Grupo representado na avaliação",
  ...
  "case_view_representation_change_who_label": "Se repetido: Mudança na representação - Quem?",
  "case_view_representation_change_what_label": "Se repetido: Mudança na representação - O quê?",
  "case_view_represented_characteristics_label": "Características do grupo representado",
  "case_view_represented_group_label": "Grupo representado",
  "case_view_represented_shaped_label": "O grupo representado definiu a agenda?",
  "case_view_anonymous_identified_label": "Online anônimo ou identificado",
  "case_view_argument_tools_label": "Ferramentas de argumentação",
  "case_view_ai_ml_label": "Inteligência artificial / Aprendizado de máquina",
  "case_view_facilitator_automation_label": "Automação da facilitação",
  "case_view_facetoface_and_online_integration_label": "Integração presencial e online",
  "case_view_gamification_label": "Gamificação",
  "case_view_synchronous_asynchronous_label": "Síncrono ou assíncrono",
  "case_view_text_video_label": "Texto e vídeo",
  "case_view_visualization_label": "Visualização",
  "case_view_virtual_reality_label": "Realidade virtual",
  "case_view_representation_claims_label": "Reivindicações de representação",
  "case_view_feedback_methods_label": "Métodos de feedback",
  "case_view_behind_claim_label": "Responsável pela reivindicação",
  ...
  "click_here_to_apply": "Clique aqui para se candidatar",
  "click_here_to_register": "Clique aqui para se registrar",
  ...
  "Co-Chairs, Teaching, Training and Mentoring Committee": "Coordenadores do Comitê de Ensino, Treinamento e Orientação",
  "Co-Founder": "Co-fundador",
  "Co-investigator": "Co-pesquisador",
  ...
  "content_types.review_entries.description": "Novas entradas devem ser aprovadas por um administrador. A aprovação de uma entrada aprovará automaticamente todas as entradas desse usuário e suas entradas futuras não exigirão revisão. Bloquear uma entrada bloqueará esse usuário e excluirá permanentemente todas as suas entradas do banco de dados. Revise com atenção.",
  "content_types.user_list.description": "Excluir um usuário excluirá e bloqueará o usuário e excluirá permanentemente todas as suas entradas do banco de dados. Revise com atenção.",
  ...
  "download": "download",
  "Drafts": "Rascunhos",
  "draft_container_description": "Continue editando suas entradas de rascunho que ainda não foram publicadas.",
  "Dutch": "Holandês",
  ...
  "faq_a15": "Todas as novas entradas são salvas automaticamente assim que qualquer dado é inserido no formulário. Se você iniciar uma entrada, mas não quiser publicá-la imediatamente, não há necessidade de clicar em salvar. Você pode inserir quantos dados desejar no formulário e fechar a janela do navegador. Depois de criar um rascunho, ele ficará acessível na página do seu perfil, na guia “rascunhos”, bem como na página de envio rápido. Você pode fazer login em qualquer dispositivo e acessar seus rascunhos. Usando o botão “visualizar” no formulário de inscrição, você pode ver como ficará uma inscrição depois de publicada. Se você esperar para publicar sua entrada até que ela esteja mais completa, a descrição e o texto narrativo serão traduzidos para todos os idiomas suportados. (Só fazemos a tradução uma vez, na primeira vez que uma entrada é publicada - veja: “Como funciona a tradução?”)",
  "faq_a16": "Para evitar a publicação de entradas de spam, exigimos que os usuários solicitem a publicação ou edição das entradas na Participaedia, e essas solicitações são aprovadas (ou bloqueadas) pelos administradores do site. Isso pode levar alguns dias, pois é feito manualmente pela nossa equipe. Uma vez aprovadas, as alterações subsequentes serão publicadas imediatamente.",
  ...
  "federal.university.minas.gerais": "A localização da próxima Escola Participapedia %s Universidade Federal de Minas Gerais (UFMG) foi cancelada %s devido a uma greve contínua de funcionários de universidades federais brasileiras. Nos solidarizamos com nossos colegas da UFMG e com os movimentos que defendem a democracia e não cruzaremos os piquetes. Infelizmente, não podemos oferecer vagas em nenhuma de nossas escolas alternativas devido aos limites de capacidade de matrícula. No entanto, convidamos os interessados a %s juntarem-se à lista de espera %s . Obrigado pela sua compreensão.",
  ...
  "filters": "Filtros",
  "Find and contribute": "Encontre e contribua",
  "Finland": "Finlândia",
  ...
  "home.participediaschool.use": "e usar a Participapedia na sala de aula para envolver os alunos e divulgar suas pesquisas. Participe das Escolas Participaedia e obtenha perspectivas globais com pesquisadores e profissionais líderes.",
  ...
  "Honduras": "Honduras",
  "Hong Kong": "Hong Kong",
  "hosted.with.partner": "Em parceria com",
  "hosted.with.partner.end": "(CERi), a CERi-Participedia Summer School on Radical Democracy (4 a 10 de junho de 2023) centrou a teoria e a prática da democracia radical para explorar temas de poder e ruptura, governança indígena, criatividade e cuidado. A escola reuniu especialistas, pesquisadores, estudantes de pós-graduação, líderes comunitários, ativistas e profissionais para uma semana de workshops, discussões, diálogos, eventos comunitários e viagens de campo. Os alunos se juntaram às ciências sociais, incluindo ciência política, filosofia política, mídia e comunicações, sociologia, estudos culturais, antropologia, economia, meio ambiente e disciplinas relacionadas. Juntos, com a equipe da escola de verão e convidados, exploramos o que significa reimaginar radicalmente, pesquisar e praticar a democracia em suas comunidades e na vida cotidiana.",
  ...
  "Mauritius": "Maurício",
  "Mayotte": "Mayotte",
  "mcmaster.university": "Universidade McMaster",
  "media_sectionlabel": "Mídia",
  "Members": "Membros",
  "member_since": "Membro desde",
  "memorial.university": "Universidade Memorial",
  "Method": "Método",
  "method": "Método",
  ...
  "missions.publiques": "Missões Públicas",
  "Moldova": "Moldávia",
  "Monaco": "Mônaco",
  "Mongolia": "Mongólia",
  ...
  "name:representation_change_who-key:yes": "Sim",
  "name:representation_change_who-key:no": "Não",
  "name:representation_change_who-key:do_not_know": "Não sei",
  "name:representation_change_what-key:yes": "Sim",
  "name:representation_change_what-key:no": "Não",
  "name:representation_change_what-key:do_not_know": "Não sei",
  "name:represented_shaped-key:yes": "Sim",
  "name:represented_shaped-key:no": "Não",
  "name:represented_shaped-key:do_not_know": "Não sei",
  "name:represented_characteristics-key:jurisdiction": "Pessoas dentro de uma jurisdição/território específico",
  "name:represented_characteristics-key:shared_identity": "Grupos predefinidos de indivíduos com base em identidade compartilhada",
  "name:represented_characteristics-key:issue_group": "Grupos predefinidos de indivíduos com base em um tema específico",
  "name:represented_characteristics-key:most_affected": "Indivíduos mais afetados",
  "name:represented_characteristics-key:voiceless": "Grupo sem voz (por exemplo, seres não humanos; gerações futuras)",
  "name:represented_group-key:children": "Crianças",
  "name:represented_group-key:lgbt": "Gays/Lésbicas/Bissexuais/Transgêneros (LGBT)",
  "name:represented_group-key:elderly": "Idosos",
  "name:represented_group-key:future_generations": "Gerações futuras",
  "name:represented_group-key:indigenous": "Povos indígenas",
  "name:represented_group-key:immigrants": "Imigrantes",
  "name:represented_group-key:lowincome": "Pessoas de baixa renda",
  "name:represented_group-key:men": "Homens",
  "name:represented_group-key:nature": "Natureza",
  "name:represented_group-key:non_human_beings": "Seres não humanos",
  "name:represented_group-key:people_with_disabilities": "Pessoas com deficiência",
  "name:represented_group-key:racial_ethnic_groups": "Grupos raciais/étnicos",
  "name:represented_group-key:religious_groups": "Grupos religiosos",
  "name:represented_group-key:stakeholder_organizations": "Organizações de stakeholders (por exemplo, ONGs, interesses empresariais)",
  "name:represented_group-key:students": "Estudantes",
  "name:represented_group-key:women": "Mulheres",
  "name:represented_group-key:youth": "Jovens",
  "name:represented_group-key:other": "Outros grupos",
  "name:argument_tools-key:argument_maps": "Mapas de argumentos",
  "name:argument_tools-key:issue_maps": "Mapas de temas",
  "name:argument_tools-key:argument_support_systems": "Sistemas de apoio a argumentos",
  "name:argument_tools-key:decision_support_systems": "Sistemas de apoio à decisão",
  "name:argument_tools-key:other": "Outros",
  "name:argument_tools-key:no": "Não",
  "name:ai_ml-key:artificial_intelligence": "Inteligência artificial",
  "name:ai_ml-key:machine_learning": "Aprendizado de máquina",
  "name:ai_ml-key:both": "Ambos",
  "name:ai_ml-key:no": "Não",
  "name:gamification-key:rewards": "Recompensas",
  "name:gamification-key:levels": "Níveis",
  "name:gamification-key:leaderboards": "Rankings",
  "name:gamification-key:missions": "Missões",
  "name:gamification-key:peer_ratings": "Avaliações entre pares",
  "name:gamification-key:other": "Outros",
  "name:gamification-key:no": "Não",
  "name:facilitator_automation-key:partly": "Parcialmente",
  "name:facilitator_automation-key:completely": "Completamente",
  "name:facilitator_automation-key:not_at_all": "De forma alguma",
  "name:facetoface_and_online_integration-key:together_synchronously": "Juntos de forma síncrona",
  "name:facetoface_and_online_integration-key:separated": "Separados",
  "name:synchronous_asynchronous-key:synchronous": "Síncrono",
  "name:synchronous_asynchronous-key:asynchronous": "Assíncrono",
  "name:synchronous_asynchronous-key:both": "Ambos",
  "name:text_video-key:text_only": "Somente texto",
  "name:text_video-key:video_and_audio": "Vídeo e áudio",
  "name:text_video-key:video_only": "Apenas vídeo",
  "name:text_video-key:audio_only": "Somente áudio",
  "name:text_video-key:other": "Outro",
  "name:visualization-key:yes": "Sim",
  "name:visualization-key:no": "Não",
  "name:virtual_reality-key:yes": "Sim",
  "name:virtual_reality-key:no": "Não",
  "name:representation_claims-key:traditional_media": "Mídia tradicional (televisão, rádio, jornais)",
  "name:representation_claims-key:new_media": "Mídia nova (redes sociais, blogs, mensagens de texto)",
  "name:representation_claims-key:independent_media": "Mídia independente (livre de influência corporativa ou governamental)",
  "name:representation_claims-key:official_communication": "Comunicação oficial",
  "name:representation_claims-key:informal_social_activities": "Atividades sociais informais",
  "name:representation_claims-key:protests_public_demonstrations": "Protestos/Manifestações públicas",
  "name:representation_claims-key:public_hearings_meetings": "Audiências/Reuniões públicas",
  "name:representation_claims-key:word_of_mouth": "Boca a boca",
  "name:representation_claims-key:surrogates": "Representantes",
  "name:representation_claims-key:other": "Outros",
  "name:feedback_methods-key:public_hearings_meetings": "Audiências/Reuniões públicas",
  "name:feedback_methods-key:oversight": "Supervisão",
  "name:feedback_methods-key:digital_engagement": "Engajamento digital",
  "name:feedback_methods-key:electoral_processes": "Processos eleitorais",
  "name:feedback_methods-key:informal_social_activities": "Atividades sociais informais",
  "name:feedback_methods-key:land_based_activities": "Atividades em terra",
  "name:feedback_methods-key:formal_long_term_channels": "Canais formais de comunicação com órgãos cívicos de longo prazo",
  "name:feedback_methods-key:other": "Outros",
  "name:feedback_methods-key:none": "Nenhum",
  "name:behind_claim-key:primary_organizer": "Organizador principal",
  "name:behind_claim-key:primary_funder": "Financiador principal",
  "name:behind_claim-key:participants_themselves": "Os próprios participantes",
  "name:most_affected-key:perfectly_represented": "Eles foram perfeitamente representados no processo",
  "name:most_affected-key:well_represented": "Eles foram bem representados",
  "name:most_affected-key:some_representation": "Eles tiveram alguma representação no processo, mas não muita",
  "name:most_affected-key:not_well_represented": "Eles NÃO foram bem representados",
  "name:most_affected-key:not_represented": "Eles NÃO foram representados no processo",
  "name:implementers_connected-key:yes": "Sim",
  "name:implementers_connected-key:no": "Não",
  "name:implementers_connected-key:do_not_know": "Não sei",
  "name:represented_evaluation-key:yes": "Sim",
  "name:represented_evaluation-key:no": "Não",
  "name:represented_evaluation-key:do_not_know": "Não sei",
  "name:anonymous_identified-key:anonymous": "Anônimos",
  "name:anonymous_identified-key:identified": "Identificados",
  ...
  "Participedia Project Director and Co-founder": "Diretor de Projetos e Co-fundador da Participedia\n",
  "Participedia School": "Escola Participação",
  "participedia.registration.scholarships.p1.1": "As inscrições e inscrições para bolsas de estudo estão encerradas. Para entrar na lista de espera,",
  "participedia.registration.scholarships.p1.2": "Todos os alimentos e bebidas durante o programa serão fornecidos aos participantes.",
  "participedia.registration.scholarships.p2": "As solicitações de bolsas de viagem e moradia estão encerradas. Um número limitado de bolsas para a isenção de inscrição está disponível. A solicitação para essas bolsas de isenção pode ser feita no formulário de inscrição.",
  "participedia.school.august": "Agosto",
  "participedia.school.download.summary.report": "Baixe o relatório resumido aqui",
  "participedia.school.fee.schedule": "Tabela de taxas",
  "participedia.school.fee.schedule.memorial": "Memorial University em St. John's Newfoundland, Canadá",
  "participedia.school.for.any.questions.contact": "Se você tiver alguma dúvida entre em contato",
  "participedia.school.h2.1": "Espaços inovadores de educação democrática co-criados pela comunidade Participaedia para estudantes, profissionais, educadores, governo e sociedade civil global.",
  "participedia.school.h2.2": "2024 Escola Participadia sobre Inovações Democráticas Transnacionais",
  "participedia.school.h2.3": "2023 Participedia School on Radical Democracy com Simon Fraser University Community Engaged Research Initiative (CERi)",
  "participedia.school.h2.democratic": "Inovações democráticas na América Latina: movimentos sociais, povos indígenas e comunidades tradicionais",
  "participedia.school.h2.digital": "Democracia Digital: Explorando Novas Formas de Representação Democrática, Participação e Governança",
  "participedia.school.h3.1": "A Escola Participadia oferecerá",
  "participedia.school.intro": "As Escolas Participedia são espaços educacionais democráticos, interdisciplinares e internacionais, cocriados pela comunidade Participedia para estudantes, profissionais, educadores, governo e sociedade civil global. Cada Escola Participedia explora inovações democráticas de uma forma única, com novos parceiros, em cidades ao redor do mundo.",
  "participedia.school.join": "Junte-se a uma das nossas próximas Escolas Participedia",
  "participedia.school.july": "Julho",
  "participedia.school.march": "Março",
  "participedia.school.ol.li.1.p1": "Treinamento de habilidades credenciado",
  "participedia.school.ol.li.1.p1.p": "Apoie uma troca de aprendizados entre profissionais, estudantes e acadêmicos sob um currículo orientado que leva ao desenvolvimento de habilidades e áreas reconhecidas com um certificado de participação do Instituto Coady. O crédito universitário pode estar disponível em sua instituição de origem, entre em contato conosco para obter mais informações.",
  "participedia.school.ol.li.2.p2": "Intercâmbio interdisciplinar, interseccional e internacional",
  "participedia.school.ol.li.2.p2.p": "Oferecer oportunidade para profissionais, estudantes e acadêmicos se envolverem com experiências, pessoas e ideias de todo o mundo em uma estrutura colaborativa que levará a novas questões de pesquisa, abordagens políticas e parcerias.",
  "participedia.school.ol.li.3.p3": "Compartilhamento, transferência e colaboração de conhecimento",
  "participedia.school.ol.li.3.p3.p": "Explore teorias de ponta, pesquisas e aprendizados baseados na experiência sobre inovações democráticas transnacionais por meio da resolução de problemas e do co-design.",
  "participedia.school.ol.li.4.p4": "Síntese e disseminação do conhecimento",
  "participedia.school.ol.li.4.p4.p": "Conscientizar e conhecer o pessoal de organizações internacionais, diplomatas, sociedade civil transnacional, ativistas e estudantes universitários sobre a teoria e a prática da democracia transnacional, sintetizando os aprendizados em uma publicação de acesso aberto.",
  "participedia.school.organized": "organizado sob o tema “Democracia Radical”, reuniu importantes especialistas, pesquisadores e estudantes de pós-graduação e líderes comunitários, ativistas e profissionais para uma semana de workshops, discussão, diálogo, eventos comunitários e visitas de campo. Nós, estudantes, ingressamos nas ciências sociais, incluindo ciências políticas, filosofia política, mídia e comunicações, sociologia, estudos culturais, antropologia, economia, meio ambiente e disciplinas relacionadas. Juntos, com a equipa da escola de verão e convidados, explorámos o que significa reimaginar, investigar e praticar radicalmente a democracia nas suas comunidades e na vida quotidiana.",
  "participedia.school.p1": "O panorama da participação pública transnacional – o envolvimento de indivíduos ou grupos de vários países em processos políticos, tomada de decisão, conceção ou defesa que transcendem as fronteiras ou questões nacionais – está a mudar rapidamente. Existem novas inovações, teorias, movimentos, políticas e sucessos acontecendo em todo o mundo. Os desafios emaranhados que enfrentamos estendem-se para além das fronteiras nacionais, tal como as suas soluções democráticas.",
  "participedia.school.p1.1": "Movimentos sociais, povos indígenas e comunidades tradicionais, por toda a América Latina e sua diáspora, criam criativamente inovações democráticas em resposta a déficits democráticos, autoritarismo e violência estatal, extração ambiental e as realidades do (neo)colonialismo e imperialismo. Essas práticas em evolução, baseadas em conhecimento e necessidades impulsionadas pela comunidade, permanecem sub-representadas, dispersas e marginalizadas nos ecossistemas do pensamento e da prática democrática.",
  ...
  "participedia.school.p1.2.1": "Democracia en Red, Extituto: Demo.Reset, Observatório de Protocolos Comunitários, Universidade Federal do Estado do Rio de Janeiro, People Powered, International IDEA, Democracy International, Universidade Federal de Viçosa e Agência de Iniciativas Cidadã",
  "participedia.school.p1.2.2": "Escola Participedia sobre Inovações Democráticas na América Latina (27 a 31 de julho de 2025)",
  "participedia.school.p1.2.3": "ajudará a mobilizar esses conhecimentos por meio de um consórcio de líderes de pensamento e prática. Os inscritos passarão por uma pedagogia de co-design baseada em problemas que reúne estudantes, acadêmicos e profissionais para diálogo, colaboração e troca inclusivos, interseccionais e internacionais. Juntos, exploraremos como as iniciativas de base existentes podem impulsionar com sucesso práticas democráticas inclusivas e justas.",
  "participedia.school.p1.2.start": "Em colaboração com a McMaster University, University of Montreal, Toronto Metropolitan University, Concordia University, University of Alberta, Federal University of Minas Gerais, Fundação Casa de Rui Barbosa, Associação Brasileira de Ciência Política, Associação Brasileira de Pós-Graduação e Pesquisa em Ciências Sociais",
  "participedia.school.p2": "Estes novos processos, métodos e ferramentas transnacionais estão a ser adoptados, quer através de mini-públicos deliberativos globais e desenhos organizacionais deliberativos transnacionais, quer através de infra-estruturas digitais e métodos de participação conectada, investigação, envolvimento e construção de coligações. Agora, mais do que nunca, precisamos de nos reunir, partilhar, ouvir aqueles com experiência e adquirir as competências para responder, aprender, identificar, investigar e conceber inovações democráticas transnacionais.",
  "participedia.school.p2.1": "A Escola Participedia 2025 sobre Inovações Democráticas na América Latina tem como objetivo",
  "participedia.school.p2.ul.li.1": "Explore conhecimentos locais juntamente com perspectivas globais e em conexão com elas, com foco nas práticas democráticas latino-americanas por meio de workshops liderados pela comunidade e projetos de co-design.",
  "participedia.school.p2.ul.li.2": "Explore conhecimentos locais juntamente com perspectivas globais e em conexão com elas, com foco nas práticas democráticas latino-americanas por meio de workshops liderados pela comunidade e projetos de co-design.",
  "participedia.school.p2.ul.li.3": "Aumentar a conscientização e preencher lacunas de conhecimento, aprofundando nossa compreensão de inovações democráticas entre profissionais, organizações, acadêmicos e estudantes em todo o mundo.",
  "participedia.school.p2.ul.li.4": "Promover a internacionalização e as habilidades de pesquisa, networking e políticas entre estudantes, acadêmicos, profissionais e líderes comunitários indígenas e não indígenas, treinando a próxima geração de líderes.",
  "participedia.school.p3": "Junte-se a nós na próxima Escola Participedia sobre Inovações Democráticas Transnacionais. Nela, você irá aprender e colaborar com os criadores da primeira assembleia global de cidadãos do mundo, com os coordenadores da Conferência sobre o Futuro da Europa, com os principais acadêmicos no campo de inovações democráticas e de governança transnacional, e com os ativistas que conduzem a campanha global para a reforma da ONU! Esta iniciativa inovadora é realizada em parceria com a Memorial University, a University of Western Cape, a McMaster University, o Coady Institute, a Universidade Federal de Minas Gerais, a Innovation for Policy Foundation, a Mission Publiques, a Democracy International e um consórcio de profissionais e acadêmicos que são referência na área de participação.",
  "participedia.school.p3.1": "O quê: Esta escola da Participedia explorará inovações democráticas latino-americanas por meio de temas de (mas não limitados a): repensar a democracia de baixo; resistência coletiva e lutas interseccionais; povos indígenas, terra e justiça climática; advocacia, autonomia e cogovernança; e tecnologia, descolonização e imaginação radical. Ela contará com um dia comunitário (27 de julho) para se envolver com organizações locais que praticam a democracia, seguido por quatro dias (28 a 31 de julho) de programação em sala de aula. O currículo incluirá painéis de palestrantes convidados renomados, discussões lideradas por especialistas, estudos de caso colaborativos e aprendizagem baseada em problemas. O currículo será credenciado pela Universidade Federal do Estado do Rio de Janeiro.",
  "participedia.school.p4": "O evento acontecerá presencialmente de 10 a 15 de junho de 2024, simultaneamente, em dois locais descentralizados: Memorial University (St. John’s, Canadá), e University of Western Cape (Cidade do Cabo, África do Sul). Os locais serão conectados por uma programação virtual exclusiva para maximizar a acessibilidade e o impacto. Utilizando esta abordagem globalmente descentralizada, esperamos criar um ecossistema transnacional de aprendizagem que reflita o assunto, conectando estudantes e profissionais de todo o mundo entre si e com especialistas líderes.",
  "participedia.school.p4.p": "Estudantes indígenas e não indígenas, acadêmicos em início de carreira, praticantes, líderes comunitários, pesquisadores da Participedia e profissionais cujo trabalho pode ser aprimorado ao aprender e se envolver com inovações democráticas lideradas pela comunidade latino-americana por meio de processos de co-design e troca de conhecimento. Este programa visa receber 50 participantes presenciais. Recomendamos fortemente que você se inscreva o mais rápido possível para garantir sua vaga. Todos os possíveis inscritos serão contatados de forma contínua no final de janeiro e fevereiro, confirmando sua vaga de inscrito.",
  "participedia.school.p5": "Os participantes podem se inscrever para participar presencialmente em todas as localidades até o preenchimento das vagas (50 vagas por campus). Bolsas limitadas estão disponíveis com base nas “necessidades” para cobrir inscrição, viagens e moradia. Todos os alimentos e bebidas serão fornecidos aos participantes.",
  "participedia.school.p5.fee.schedule.p": "Devido às regulamentações brasileiras, não há taxa de inscrição para este evento.",
  "participedia.school.p6": "Tecnologias inteligentes e digitais surgiram como uma força importante na reformulação de instituições democráticas e governança pública em todo o mundo. Atualmente, mais de dez cidades estão pilotando democracia local digital ou iniciativas participativas em toda a China. Para entender essas práticas inovadoras, examine questões e tensões emergentes no desenvolvimento de infraestruturas digitais públicas e identifique áreas de melhoria, Participedia e Governança. O programa da escola de verão abrangerá mais de 40 horas em 4 dias e dois países.",
  "participedia.school.p6.1": "Tecnologias inteligentes e digitais surgiram como uma força importante na reformulação de instituições democráticas e governança pública em todo o mundo. Atualmente, mais de dez cidades estão pilotando democracia local digital ou iniciativas participativas em toda a China. Para entender essas práticas inovadoras, examinar questões emergentes e tensões no desenvolvimento de infraestruturas digitais públicas e identificar áreas de melhoria, temos o prazer de anunciar",
  "participedia.school.p6.2": "Escola Participedia sobre Democracia Digital: Explorando Novas Formas de Representação Democrática, Participação e Governança (11 a 15 de agosto de 2025).",
  "participedia.school.p6.3": "O programa Participedia School terá mais de 40 horas em 4 dias e dois países (China e Japão).",
  "participedia.school.p7.summer": "A Escola Participedia 2025 sobre Democracia Digital tem como objetivo",
  "participedia.school.p7.ul.li.1.p": "Ofereça aos aspirantes a acadêmicos e profissionais em democracia digital uma experiência imersiva, envolvendo-se com as últimas inovações, pesquisas e aplicações do mundo real na área.",
  "participedia.school.p7.ul.li.1.strong": "Capacite a próxima geração de pesquisadores",
  "participedia.school.p7.ul.li.2.p": "Examine as principais questões decorrentes de iniciativas recentes de democracia digital, como a criação de E-fóruns para promover maior participação pública e aprimorar a qualidade dos processos deliberativos. O programa também se aprofunda em como as ferramentas digitais podem expandir e reimaginar estruturas tradicionais de representação eleitoral.",
  "participedia.school.p7.ul.li.2.strong": "Explore desafios e oportunidades emergentes",
  "participedia.school.p7.ul.li.3.p": "Identificar lacunas críticas e oportunidades de colaboração para enfrentar desafios urgentes, incluindo o combate à fraude digital, a garantia de acesso equitativo e o aumento da confiança e da transparência nos sistemas democráticos.",
  "participedia.school.p7.ul.li.3.strong": "Promover a inovação e a colaboração",
  "participedia.school.p8.content": "Esta Escola Participedia explorará a democracia digital por meio de temas de IA e democracia, participação digital, democracia deliberativa digital, algoritmos em supervisão democrática, infraestrutura digital pública, integridade democrática e salvaguardas tecnológicas contra fraude digital. Ela abrangerá mais de 40 horas em 4 dias de aula. O currículo também incentivará os alunos a utilizar o repositório de casos da Participedia.",
  "participedia.school.p9.who.p": "Estudantes de pós-graduação, professores, líderes comunitários, autoridades governamentais locais, pesquisadores da Participedia e profissionais cujo trabalho pode ser aprimorado ao aprofundar a compreensão e o engajamento com a democracia digital. O programa tem como objetivo hospedar 80 participantes presenciais, com participantes adicionais se juntando online. Além dos inscritos regionais, temos espaço para até 20 participantes internacionais autofinanciados.",
  "participedia.school.past": "Escolas Participedia anteriores",
  "participedia.school.past.p1": "As escolas Participedia envolvem design de processo iterativo enraizado no design thinking. Revise os aprendizados de escolas passadas baixando relatórios de resumo abaixo.",
  "participedia.school.past.p1.end": "e Innovation for Policy Foundation, Participedia School on Transnational Democratic Innovations (10 a 15 de junho de 2024) foi hospedado simultaneamente pela Memorial University of Newfoundland, Canadá e pela University of the Western Cape, África do Sul. Com dois locais descentralizados, este evento transnacional reuniu mais de 110 alunos, professores, profissionais, pesquisadores e facilitadores para compartilhar, ouvir, projetar e aprender uns com os outros. Juntos, criamos um ecossistema global de aprendizagem para explorar o envolvimento transnacional de indivíduos ou grupos de vários países em processos políticos, tomada de decisão, design ou advocacia que transcendem fronteiras e questões nacionais. Novas inovações, teorias, movimentos, políticas e sucessos estão acontecendo ao redor do mundo, e a Participedia School 2024 explorou esses processos, métodos e ferramentas participativas transnacionais, vendo aceitação. Centralizando a troca intersetorial e interdisciplinar, nos reunimos para co-projetar inovações democráticas transnacionais e a teoria e prática da democracia através das fronteiras.",
  "participedia.school.past.p1.first": "Em parceria com",
  "participedia.school.past.places": "Cidade do Cabo, África do Sul e St Johns, Canadá",
  "participedia.school.past.radical.democracy": "Democracia Radical",
  "participedia.school.past.transnational": "Inovações Democráticas Transnacionais",
  "participedia.school.past.vancouver.canada": "Vancouver, Canadá",
  "participedia.school.places": "Fundação Casa de Rui Barbosa, Rio de Janeiro, Brasil",
  "participedia.school.places.2": "Universidade Tsinghua em Pequim, China e a Universidade Internacional do Japão em Minami Uonuma, Niigata, Japão",
  "participedia.school.registration": "Inscrição",
  "participedia.school.registration.1": "Para se candidatar à escola, clique em",
  "participedia.school.registration.2": "Se você tiver alguma dúvida, entre em contato",
  "participedia.school.registration.2.1": "Para se registrar na escola, clique em",
  "participedia.school.registration.2.2": "Se você tiver alguma dúvida, entre em contato",
  "participedia.school.registration.here": "Aqui",
  "participedia.school.summary.video": "Vídeo da Escola de Verão 2023 por SFU CERi",
  "participedia.school.summer.school": "Escola de Verão CERi-Participedia",
  "participedia.school.travel": "Viagem",
  "participedia.school.ui.1.li.1": "Idioma: Inglês (Primário)",
  "participedia.school.ui.1.li.2": "Taxa de praticante: $800 CDN",
  "participedia.school.ui.1.li.3": "Taxa de estudante: $800 CDN",
  "participedia.school.ui.2.li.1": "Idioma: Inglês (Primário)",
  "participedia.school.ui.2.li.2": "Taxa de praticante: $800 CDN",
  "participedia.school.ui.2.li.3": "Taxa de estudante: $800 CDN",
  "participedia.school.university": "Universidade de Western Cape na Cidade do Cabo, África do Sul",
  "participedia.school.usd": "USD",
  "participedia.school.usd.paid": "a ser pago por",
  "participedia.school.week.overview": "Visão geral da semana",
  "participedia.school.what": "o que",
  "participedia.school.when": "Quando",
  "participedia.school.when.date": "Junho",
  "participedia.school.where": "Onde",
  "participedia.school.where.answer": "Memorial University (MUN), St. Johns, Newfoundland, Canadá; Universidade de Western Cape, Cidade do Cabo.",
  "participedia.school.where.august.11.25": "Universidade Tsinghua em Pequim, China",
  "participedia.school.where.international.university": "Universidade Internacional do Japão em Minami Uonuma, Niigata, Japão",
  "participedia.school.who": "Quem",
  "participedia.school.who.answer": "Profissionais cujo trabalho pode ser melhorado através do aprofundamento da participação além-fronteiras e da aplicação de práticas participativas transnacionais; profissionais, defensores e redes da sociedade civil cujo impacto pode ser reforçado pela participação estratégica e pela capacidade de criar, conceber e promover inovações democráticas transnacionais; e estudantes do ensino superior interessados na teoria e prática da democracia além-fronteiras.",
  ...
  "please_fill_out_this_form": "por favor preencha este formulário.",
  "Poland": "Polônia",
  "Portugal": "Portugal",
  ...
  "Project Director, Co-Founder and Principal Investigator": "Diretor do projeto, cofundador e pesquisador principal",
  ...
  "Registration & Scholarships": "Inscrições e Bolsas",
  ...
  "simon.fraser": "Iniciativa de Pesquisa Comunitária Engajada da Universidade Simon Fraser",
  "Singapore": "Cingapura",
  "Slovakia": "Eslováquia",
  "Slovenia": "Eslovênia",
  ...
  "teaching_resources": "recursos didáticos",
  ...
  "the.coady.institute": "o Instituto Coady",
  "the.university.of.western.cape": "a Universidade do Cabo Ocidental",
  ...
  "Uganda": "Uganda",
  "Ukraine": "Ucrânia",
  "UMFG Information": "Informações UMFG",
  "umfg.Information.part3": "devido a uma greve contínua de funcionários de universidades federais brasileiras. Nos solidarizamos com nossos colegas da UFMG e com os movimentos que defendem a democracia e não cruzaremos os piquetes. Infelizmente, não podemos oferecer vagas em nenhuma de nossas escolas alternativas devido aos limites de capacidade de matrícula. No entanto, convidamos os interessados a",
  ...
  "participedia.school.events.cta": "Visite %sParticipedia.org/participedia-school%s para obter mais informações sobre nossos eventos da Participedia School.",
  "search_chart_title_case": "Dados de casos",
  "search_chart_title_method": "Dados de métodos",
  "search_chart_title_organization": "Dados de organizações",
  "case_edit_theme_label": "Qual tema melhor representa este caso?",
  "case_edit_theme_instructional": "A Participedia usa temas para organizar a pesquisa e a mobilização de conhecimento sobre inovações democráticas. Selecione até três dos temas a seguir e classifique-os por relevância. Se houver outro tema que represente melhor este caso, descreva-o na seção narrativa.",
  "case_edit_theme_placeholder": "Selecione e classifique até três temas",
  "case_view_theme_label": "Tema",
  "case_edit_impact_outcome_label": "Este caso atingiu o resultado ou impacto desejado?",
  "case_edit_impact_outcome_instructional": "Indique se este caso alcançou, não alcançou ou alcançou parcialmente o resultado ou impacto desejado, durante ou após a implementação. Selecione uma das opções a seguir e explique sua escolha na seção \"Influência, resultados e efeitos\" da narrativa escrita.",
  "case_edit_impact_outcome_placeholder": "Selecione uma opção no menu suspenso",
  "case_view_impact_outcome_label": "Resultado ou impacto alcançado",
  "name:theme-key:participatory_democratic_governance": "Governança participativa e democrática",
  "name:theme-key:human_political_rights": "Direitos humanos e políticos",
  "name:theme-key:democracy_across_borders": "Democracia além-fronteiras",
  "name:theme-key:democracy_digital_communications": "Democracia e comunicações digitais",
  "name:theme-key:indigenous_rights": "Direitos indígenas",
  "name:theme-key:democratic_accountability": "Responsabilização democrática",
  "name:theme-key:democratic_representation": "Representação democrática",
  "name:theme-key:data_driven_democracy": "Democracia orientada por dados",
  "name:impact_outcome-key:yes": "Sim",
  "name:impact_outcome-key:no": "Não",
