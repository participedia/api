{
  ...
  "about.cases.p1": "Entries about cases document specific uses of methods of public participation. Cases can be contemporary or historical, completed, or ongoing. ",
  ...
  "about.content.p1": "Participedia offers a searchable database of content related to worldwide public participation. Please read our %sguidelines%s on how to write entries.",
  "about.contribute.p1": "Help expand our database by editing existing content or publishing your own. Please read our entry-writing %sguidelines%s.",
  ...
  "about.methods.p1": "Entries about methods provide information on the overarching processes used to guide public participation, such as citizens’ juries, deliberative polling, participatory budgeting, and many more. ",
  ...
  "about.organizations.p1": "Entries about organizations provide profiles of formal and informal groups that design, implement, or support participatory innovations. ",
  ...
  "about.teach.p1": "Use Participedia in the classroom to engage students and showcase their research. Visit our %sTeaching%s page for more information.",
  ...
  "about.teaching_resources.p1": "The %sTeaching & Learning Resource Center%s provides resources for undergraduate and graduate classroom settings, as well as professional development resources for practitioners, civil society organizations, and NGOs. Resources range from course syllabi and class assignments, to handbooks, simulations, and multi-media training material. You can submit teaching resources %shere%s. ",
  ...
  "case_edit_photos_instructional": "Upload images here. Supported file types include: jpg, jpeg and png. Max file size is 5MB. ",
  ...
  "false": "False",
  "FAQ": "FAQ",
  "faq_a1": "Entries about cases document specific uses of methods of public participation. Cases can be contemporary or historical, completed, or ongoing. Please read our %sguidelines%s on how to write a case.",
  "faq_a10_p1": "By default, the homepage displays a curated set of featured content. Explore the homepage map to search for cases and organizations by location.",
  "faq_a10_p2": "Use the search bar at the top of any page to conduct a site-wide keyword search. Once your search results are displayed, you can sort them by content type such as cases, methods, or organizations.",
  ...
  "faq_a2": "Entries about methods provide information on the overarching processes used to guide public participation, such as citizens’ juries, deliberative polling, and participatory budgeting. Please read our %sguidelines%s on how to write a method. ",
  ...
  "method_edit_photos_instructional": "Upload images here. Supported file types include: jpg, jpeg and png. Max file size is 5MB.",
  ...
  "organization_edit_photos_instructional": "Upload images here. Supported file types include: jpg, jpeg and png. Max file size is 5MB.",
  ...
  "photos_instructional": "Upload images here. Supported file types include: jpg, jpeg and png. Max file size is 5MB.",
  "photos_label": "Photos",
  "Pitcairn": "Pitcairn",
  "Poland": "Poland",
  "Portugal": "Portugal",
  ...
  "getting-started.p1": "Anyone from around the world can help document participatory initiatives by publishing and editing crowdsourced entries on participedia.net.",
  "getting-started.p2": "Participedia is a crowdsourcing platform for researchers and practitioners interested in public participation. The site is home to over a thousand cases from nearly 70 countries and has an active community of contributors who use the site to study and design effective methods of citizen engagement. The site is currently available in 7 languages, and features two key types of contributors: Publishers and Editors.",
  "Publishers" : "Publishers",
  "getting-started.publishers.p1": "Most often people who publish new entries on Participedia are students, practitioners and organizers of participatory events. Students may be assigned course work related to Participedia, either for researching or documenting participatory initiatives, such as this collection contributed by Coady International Centre graduates. Practitioners may use the site to document and publicize their methods, cases and organizations. Organizers who publish entries on Participedia may benefit from increased discoverability of their work, at the same time contributing to a collaborative effort to document participatory initiatives and gaining access to a database of inspiring examples and methods.",
  "getting-started.publishers.key_considerations": "Key Considerations for Publishers",
  "getting-started.publishers.key_considerations.p1": "Participedia contains three entry types: cases, methods, and organizations. Read more about entry types in the %sFAQs%s",
  ...
  "getting-started.publishers.key_considerations.p5": "New entries are automatically translated into all supported languages, but only the first time they are published. Read more about how translations work in the %sFAQs%s.",
  "getting-started.publishers.key_considerations.p6": "Write in the third person, not the first person.",
  "Editors": "Editors",
  "getting-started.editors.p1": "Editors could be adding additional information to a case, method or organization such as citations, images, links to supporting documents or external websites. Most often, people who edit existing entries on Participedia are students and other researchers. Course assignments related to participedia often involve improving partially complete entries “stubs.” Researchers may be editors on entries that are related to their particular area of focus.",
  "getting-started.editors.p2": "The Participedia Team additionally includes staff editors, who review the content on Participedia, curate collections, and flag entries with editing prompts such as completeness and required citations for improvement by Participedia’s community of editing contributors.",
  "getting-started.editors.key_considerations": "Key Considerations for Editors",
  "getting-started.editors.key_considerations.p1": "On the %ssearch page%s, use the search filter called “entry completeness” to find entries listed as stubs or partially complete, as well as entries that need citations. For example %shere are cases that are flagged as stubs%s",
  "getting-started.editors.key_considerations.p2": "Add information or images related to a participatory event you attended (ie: protest, participatory budgeting event, etc)",
  "getting-started.editors.key_considerations.p3": "Use search filters to look for entries near you and conduct research to add more content to those entries. For example an entry might need images, links to supporting documents, or external websites.",
