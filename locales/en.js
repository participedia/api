{
  ...
  "case_edit_representation_change_who_instructional": "If the process is repeated over time, were there changes regarding who was acting on behalf of the represented group?",
  "case_edit_representation_change_who_label": "If Repeated: Representation Change - Who?",
  "case_edit_representation_change_who_placeholder": "Choose one option",
  "case_edit_representation_change_what_instructional": "If the process is repeated over time, were there changes regarding who or what is being represented?",
  "case_edit_representation_change_what_label": "If Repeated: Representation Change - What?",
  "case_edit_representation_change_what_placeholder": "Choose one option",
  "case_edit_represented_shaped_instructional": "Was the represented group able to shape the agenda?",
  "case_edit_represented_shaped_label": "Did the represented group shape the agenda?",
  "case_edit_represented_shaped_placeholder": "Choose one option",
  ...
  "case_edit_represented_characteristics_instructional": "What characteristics identify the represented group? Think about the process and the issues under consideration. What is the main characteristic that defines the represented group?",
  "case_edit_represented_characteristics_label": "Represented Group Characteristics",
  "case_edit_represented_characteristics_placeholder": "Select & rank up to 3 characteristics",
  "case_edit_represented_group_instructional": "Who or what is being represented by the process?",
  "case_edit_represented_group_label": "Represented Group",
  "case_edit_represented_group_placeholder": "Choose one or multiple options",
  "case_edit_argument_tools_instructional": "Were digital tools for structuring or mapping the argument -- such as argument maps, issue maps, argument-support systems, decision-support systems, etc. -- used? Please note any specific tools in the text-based narrative section of this case.",
  "case_edit_argument_tools_label": "Argument Tools",
  "case_edit_argument_tools_placeholder": "Select up to three",
  "case_edit_gamification_instructional": "Were gamification techniques used? Please note any specific gamification techniques in the text-based narrative section of this case.",
  "case_edit_gamification_label": "Gamification",
  "case_edit_gamification_placeholder": "Select up to three",
  "case_edit_facilitator_automation_instructional": "Was facilitation automated partly or completely?",
  "case_edit_facilitator_automation_label": "Facilitator Automation",
  "case_edit_facilitator_automation_placeholder": "Select one",
  "case_edit_facetoface_and_online_integration_instructional": "Where interaction was both face-to-face and online, were face-to-face and online participants interacting together synchronously in the same session?",
  "case_edit_facetoface_and_online_integration_label": "Face to Face and Online Integration",
  "case_edit_facetoface_and_online_integration_placeholder": "Select one",
  "case_edit_synchronous_asynchronous_instructional": "Was online interaction synchronous or asynchronous or both?",
  "case_edit_synchronous_asynchronous_label": "Synchronous Asynchronous",
  "case_edit_synchronous_asynchronous_placeholder": "Select one",
  "case_edit_text_video_instructional": "Was online interaction via text only or audiovisual communication? Describe the media used in the text-based narrative section of this case.",
  "case_edit_text_video_label": "Text Video",
  "case_edit_text_video_placeholder": "Select one",
  "case_edit_visualization_instructional": "Did the online system offer a visual display of the characteristics of the discussion? Did the online system offer a visual display of the characteristics of the discussion, such as the degree of agreement among participants or the level of support for proposed actions?",
  "case_edit_visualization_label": "Visualization",
  "case_edit_visualization_placeholder": "Select one",
  "case_edit_virtual_reality_instructional": "Did the online system enable participants to experience virtual reality?",
  "case_edit_virtual_reality_label": "Virtual Reality",
  "case_edit_virtual_reality_placeholder": "Select one",
  "case_edit_representation_claims_instructional": "How were claim made to establish a connection between the process and a specific group or community was communicated? Select up to three ways by which the claim made to establish a connection between the process and a specific group or community was communicated.",
  "case_edit_representation_claims_label": "Representation Claims Made",
  "case_edit_representation_claims_placeholder": "Select and rank up to three",
  "case_edit_feedback_methods_instructional": "What methods, if any, were used by the represented group or community to provide feedback on the process?",
  "case_edit_feedback_methods_label": "Feedback Methods",
  "case_edit_feedback_methods_placeholder": "Select up to three",
  "case_edit_behind_claim_instructional": "Think about the claim made that the process was representative of a specific group or community. Which entity was behind the claim?",
  "case_edit_behind_claim_label": "Behind Claim",
  "case_edit_behind_claim_placeholder": "Select one",
  "case_edit_most_affected_instructional": "Think of those whose lives are most affected by the issues discussed in the process. How well represented were these people or things in the process?",
  "case_edit_most_affected_label": "Most Affected",
  "case_edit_most_affected_placeholder": "Select one",
  "case_edit_implementers_connected_instructional": "Are the implementers of change connected to the represented group?",
  "case_edit_implementers_connected_label": "Implementers Connected",
  "case_edit_implementers_connected_placeholder": "Select one",
  ...
  "case_edit_ai_ml_instructional": "Was artificial intelligence or machine learning used in the online system?",
  "case_edit_ai_ml_label": "Artificial Intelligence Machine Learning",
  "case_edit_ai_ml_placeholder": "Select one",
  ...
  "case_view_representation_change_who_label": "If Repeated: Representation Change - Who?",
  "case_view_representation_change_what_label": "If Repeated: Representation Change - What?",
  "case_view_represented_characteristics_label": "Represented Group Characteristics",
  "case_view_represented_group_label": "Represented Group",
  "case_view_represented_shaped_label": "Did the represented group shape the agenda?",
  "case_view_anonymous_identified_label": "Anonymous or Identified Online",
  "case_view_argument_tools_label": "Argument Tools",
  "case_view_ai_ml_label": "Artificial Intelligence / Machine Learning",
  "case_view_facilitator_automation_label": "Facilitator Automation",
  "case_view_facetoface_and_online_integration_label": "Face to Face and Online Integration",
  ...
  "name:representation_change_who-key:yes": "Yes",
  "name:representation_change_who-key:no": "No",
  "name:representation_change_who-key:do_not_know": "Do not know",
  "name:representation_change_what-key:yes": "Yes",
  "name:representation_change_what-key:no": "No",
  "name:representation_change_what-key:do_not_know": "Do not know",
  "name:represented_shaped-key:yes": "Yes",
  "name:represented_shaped-key:no": "No",
  "name:represented_shaped-key:do_not_know": "Do not know",
  "name:represented_characteristics-key:jurisdiction": "People within a specific jurisdiction/territory",
  "name:represented_characteristics-key:shared_identity": "Pre-defined groups of individuals based on shared identity",
  "name:represented_characteristics-key:issue_group": "Pre-defined groups of individuals based on a specific issue",
  "name:represented_characteristics-key:most_affected": "Most affected individuals",
  "name:represented_characteristics-key:voiceless": "Group without a voice (e.g., non-human beings; future generations)",
  "name:represented_group-key:children": "Children",
  "name:represented_group-key:lgbt": "Gay/Lesbian/Bisexual/Transgender (i.e. LGBT)",
  "name:represented_group-key:elderly": "Elderly",
  "name:represented_group-key:future_generations": "Future generations",
  "name:represented_group-key:indigenous": "Indigenous People",
  "name:represented_group-key:immigrants": "Immigrants",
  "name:represented_group-key:lowincome": "Low-Income Earners",
  "name:represented_group-key:men": "Men",
  "name:represented_group-key:nature": "Nature",
  "name:represented_group-key:non_human_beings": "Non-human beings",
  "name:represented_group-key:people_with_disabilities": "People with Disabilities",
  "name:represented_group-key:racial_ethnic_groups": "Racial/Ethnic Groups",
  "name:represented_group-key:religious_groups": "Religious Groups",
  "name:represented_group-key:stakeholder_organizations": "Stakeholder Organizations (e.g. NGOs, business interests)",
  "name:represented_group-key:students": "Students",
  "name:represented_group-key:women": "Women",
  "name:represented_group-key:youth": "Youth",
  "name:represented_group-key:other": "Other group(s)",
  "name:argument_tools-key:argument_maps": "Argument maps",
  "name:argument_tools-key:issue_maps": "Issue maps",
  "name:argument_tools-key:argument_support_systems": "Argument-support systems",
  "name:argument_tools-key:decision_support_systems": "Decision-support systems",
  "name:argument_tools-key:other": "Other",
  "name:argument_tools-key:no": "No",
  ...
  "name:synchronous_asynchronous-key:synchronous": "Synchronous",
  "name:synchronous_asynchronous-key:asynchronous": "Asynchronous",
  "name:synchronous_asynchronous-key:both": "Both",
  "name:text_video-key:text_only": "Text Only",
  "name:text_video-key:video_and_audio": "Video and Audio",
  "name:text_video-key:video_only": "Video Only",
  "name:text_video-key:audio_only": "Audio Only",
  "name:text_video-key:other": "Other",
  "name:visualization-key:yes": "Yes",
  "name:visualization-key:no": "No",
  "name:virtual_reality-key:yes": "Yes",
  "name:virtual_reality-key:no": "No",
  "name:representation_claims-key:traditional_media": "Traditional Media (television, radio, newspapers)",
  "name:representation_claims-key:new_media": "New Media (social media, blogging, texting)",
  "name:representation_claims-key:independent_media": "Independent Media (free of corporate or government influence)",
  "name:representation_claims-key:official_communication": "Official Communication",
  "name:representation_claims-key:informal_social_activities": "Informal Social Activities",
  "name:representation_claims-key:protests_public_demonstrations": "Protests/Public Demonstrations",
  "name:representation_claims-key:public_hearings_meetings": "Public Hearings/Meetings",
  "name:representation_claims-key:word_of_mouth": "Word of Mouth",
  "name:representation_claims-key:surrogates": "Surrogates",
  "name:representation_claims-key:other": "Others",
  "name:feedback_methods-key:public_hearings_meetings": "Public Hearings/Meetings",
  "name:feedback_methods-key:oversight": "Oversight",
  "name:feedback_methods-key:digital_engagement": "Digital Engagement",
  "name:feedback_methods-key:electoral_processes": "Electoral Processes",
  "name:feedback_methods-key:informal_social_activities": "Informal Social Activities",
  "name:feedback_methods-key:land_based_activities": "Land-Based Activities",
  "name:feedback_methods-key:formal_long_term_channels": "Formal communication channels with long-term civic bodies",
  "name:feedback_methods-key:other": "Others",
  "name:feedback_methods-key:none": "None",
  "name:behind_claim-key:primary_organizer": "Primary organizer",
  "name:behind_claim-key:primary_funder": "Primary funder",
  "name:behind_claim-key:participants_themselves": "Participants themselves",
  "name:most_affected-key:perfectly_represented": "They were perfectly represented in the process",
  "name:most_affected-key:well_represented": "They were well represented",
  "name:most_affected-key:some_representation": "They had some representation in the process, but not a lot",
  "name:most_affected-key:not_well_represented": "They were NOT well represented",
  "name:most_affected-key:not_represented": "They were NOT represented in the process at all",
  "name:implementers_connected-key:yes": "Yes",
  "name:implementers_connected-key:no": "No",
  "name:implementers_connected-key:do_not_know": "Do not know",
  "name:represented_evaluation-key:yes": "Yes",
  "name:represented_evaluation-key:no": "No",
  "name:represented_evaluation-key:do_not_know": "Do not know",
  "name:ai_ml-key:artificial_intelligence": "Artificial Intelligence",
  "name:ai_ml-key:machine_learning": "Machine Learning",
  "name:ai_ml-key:both": "Both",
  ...
  "upload_error_message": "Sorry, we couldn't upload that file. Please try again.",
  ...
  "participedia.school.p7.summer":"Participedia School 2025 on Digital Democracy aims to",
  ...
  "participedia.school.p6.3":"The Participedia School program will span over 40 hours across 4 days, and two countries (China and Japan).",
  ...
  "participedia.school.events.cta": "Visit %sParticipedia.org/participedia-school%s for more information about our Participedia School events.",
  "search_chart_title_case": "Case Data",
  "search_chart_title_method": "Method Data",
  "search_chart_title_organization": "Organization Data",
  "case_edit_theme_label": "What theme best represents this case?",
  "case_edit_theme_instructional": "Participedia uses themes to organize research and knowledge mobilization on democratic innovations. Please select up to three of the following themes, and rank them in order of relevancy. If there is another theme that better represents this case, please describe it in the narrative section.",
  "case_edit_theme_placeholder": "Select and rank up to three themes",
  "case_view_theme_label": "Theme",
  "case_edit_impact_outcome_label": "Did this case achieve desired outcome or impact?",
  "case_edit_impact_outcome_instructional": "Indicate if this case largely achieved, did not achieve or partially achieved its desired outcome or impact, either during or following implementation. Please select one of the following options, and explain your selection in the \"Influence, Outcomes, and Effects\" section of the written narrative.",
  "case_edit_impact_outcome_placeholder": "Select one from the drop down menu",
  "case_view_impact_outcome_label": "Outcome or Impact Achieved",
  "name:theme-key:participatory_democratic_governance": "Participatory & Democratic Governance",
  "name:theme-key:human_political_rights": "Human & Political Rights",
  "name:theme-key:democracy_across_borders": "Democracy Across Borders",
  "name:theme-key:democracy_digital_communications": "Democracy & Digital Communications",
  "name:theme-key:indigenous_rights": "Indigenous Rights",
  "name:theme-key:democratic_accountability": "Democratic Accountability",
  "name:theme-key:democratic_representation": "Democratic Representation",
  "name:theme-key:data_driven_democracy": "Data Driven Democracy",
  "name:impact_outcome-key:yes": "Yes",
  "name:impact_outcome-key:no": "No",
  "name:impact_outcome-key:partially": "Partially"
}
