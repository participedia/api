...
const COUNT_GENERAL_ISSUES_FOR_CHART = sql("../sql/count_general_issues_for_chart.sql");
const COUNT_SCOPE_OF_INFLUENCE_CHART = sql("../sql/count_scope_of_influence_chart.sql");
...
module.exports = {
  ...
  COUNT_SCOPE_OF_INFLUENCE_CHART
};