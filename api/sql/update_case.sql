...
-- list of keys
  ...
  representation_change_what = ${representation_change_what},
  represented_shaped = ${represented_shaped},
  anonymous_identified = ${anonymous_identified},
  represented_characteristics = ${represented_characteristics},
  represented_group = ${represented_group},
  ai_ml = ${ai_ml},
  argument_tools = ${argument_tools},
  facilitator_automation = ${facilitator_automation},
  facetoface_and_online_integration = ${facetoface_and_online_integration},
  gamification = ${gamification},
  synchronous_asynchronous = ${synchronous_asynchronous},
  text_video = ${text_video},
  visualization = ${visualization},
  virtual_reality = ${virtual_reality},
  representation_claims = ${representation_claims},
  feedback_methods = ${feedback_methods},
  behind_claim = ${behind_claim},
  most_affected = ${most_affected},
  implementers_connected = ${implementers_connected},
  represented_evaluation = ${represented_evaluation}
