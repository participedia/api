...
SELECT
  ...
  latitude,
  longitude,
  get_case_view_localized_value(${lang},'scope', scope_of_influence) as scope_of_influence,
  ...
  get_case_view_localized_value(${lang},'recruitment_method', recruitment_method) as recruitement_method,
