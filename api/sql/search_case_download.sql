...
--   get_components(cases.id, ${language}) as has_components,
  ...
  cases.representation_change_who,
  cases.representation_change_what,
  cases.represented_shaped,
  cases.anonymous_identified,
  COALESCE(cases.represented_characteristics, '{}') as represented_characteristics,
  COALESCE(cases.represented_group, '{}') as represented_group,
  cases.ai_ml,
  COALESCE(cases.argument_tools, '{}') as argument_tools,
  cases.facilitator_automation,
  cases.facetoface_and_online_integration,
  COALESCE(cases.gamification, '{}') as gamification,
  cases.synchronous_asynchronous,
  cases.text_video,
  cases.visualization,
  cases.virtual_reality,
  COALESCE(cases.representation_claims, '{}') as representation_claims,
  COALESCE(cases.feedback_methods, '{}') as feedback_methods,
  cases.behind_claim,
  cases.most_affected,
  cases.implementers_connected,
  cases.represented_evaluation,
