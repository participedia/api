                      ...
                      if (
                        ...
                        jimp.read(object.Body, (err, img) => {
                          if (err) {
                            ...
                            if (
                              img.bitmap.width > 600 ||
                              img.bitmap.height > 600
                            ) {
                              // Resize required
                              let resizeW = 600;
                              ...
                              // the image is too small to be resized, just upload to the new bucket
                              img.getBase64(
                                object.ContentType,
                                (err, imgData) => {
                                  if (err) {
                        ...
                        // No need to upload thumbnail for anything else but images
                        uploadCb();
                      }
                    },
                    uploadCb => {
                      // Full size image and other file types upload
                      if (
                        object.ContentType === "image/png" ||
                        object.ContentType === "image/jpg" ||
                        object.ContentType === "image/jpeg"
                        ...
                        jimp.read(object.Body, (err, img) => {
                          if (err) {
                            ...
                            if (
                              img.bitmap.width > 1600 ||
                              img.bitmap.height > 1600
                            ) {
                              // Resize required
                              let resizeW = 1600;
                              let resizeH = jimp.AUTO;
