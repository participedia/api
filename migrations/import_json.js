...
const columns = {
  ...
  cases: "id,type,original_language,post_date,published,updated_date,location_name,address1,address2,city,province,postal_code,country,latitude,longitude,files,tags,featured,relationships,issues,specific_topics,theme,is_component_of,scope_of_influence,start_date,end_date,ongoing,time_limited,purposes,approaches,public_spectrum,number_of_participants,open_limited,recruitment_method,targeted_participants,legality,facilitators,facilitator_training,facetoface_online_or_both,participants_interactions,learning_resources,decision_methods,if_voting,insights_outcomes,primary_organizers,organizer_types,funder,funder_types,staff,volunteers,impact_outcome,impact_evidence,change_types,implementers_of_change,formal_evaluation,evaluation_reports,evaluation_links,links,hidden,videos,images".split(
    ","
  ),
