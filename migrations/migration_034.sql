...
ALTER TABLE methods ADD COLUMN facilitators TEXT DEFAULT null;
UPDATE methods SET facilitators = 'yes' WHERE facilitated = TRUE;
UPDATE methods SET facilitators = 'no' WHERE facilitated = FALSE;
